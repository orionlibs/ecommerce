...
/**
 * {@link com.hybris.backoffice.actionbar.ActionDefinition} represented by {@link Menu} component
 */
public class MenuActionComponent implements ActionComponent
{
    private final Menu menuitem;


    public MenuActionComponent(final Menu menuitem)
    {
