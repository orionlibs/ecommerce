...
public class ItemCommentsController extends DefaultWidgetController
{
    ...
    protected static final String SCLASS_ADD_COMMENT_SECTION_BUTTON_OK = "yw-add-comment-section-button-ok y-btn-primary";
    protected static final String SCLASS_ADD_COMMENT_SECTION_BUTTON_CANCEL = "yw-add-comment-section-button-cancel";
    protected static final String SCLASS_ADD_COMMENT_SECTION_BUTTON_TRANSPARENT = "y-btn-transparent";
    ...
    private static final String DEFAULT_DATE_FORMAT = "yyyy.MM.dd @ hh:mm a";
    ...
    @WireVariable
    private transient UIDateRendererProvider uiDateRendererProvider;
    ...
    public void showNewCommentSection()
    {
        runWithReopeningPopup(() -> {
            ...
            textbox.addEventListener(Events.ON_CHANGING,
                            (InputEvent event) -> okButton.setDisabled(StringUtils.isBlank(event.getValue())));
            ...
            cancelButton.addSclass(SCLASS_ADD_COMMENT_SECTION_BUTTON_TRANSPARENT);
    ...
    protected void initDateFormatter()
    {
        ...
        final TimeZone formatTimeZone = getUIDateRendererProvider().getFormatTimeZone();
