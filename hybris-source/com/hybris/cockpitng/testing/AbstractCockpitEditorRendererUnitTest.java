...
public abstract class AbstractCockpitEditorRendererUnitTest<K, T extends CockpitEditorRenderer<K>>
                extends AbstractCockpitngUnitTest<T>
{
    public abstract T getEditorInstance();
    ...
    public void testNullSafe()
    {
        ...
        testNullSafeMethods(getEditorInstance(), toCall);
    }
    ...
    {
        return ReflectionUtils.extractGenericParameterType(getClass(), 1);
    }
}
