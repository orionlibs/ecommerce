 ...
 */
public class ObjectCloningException extends ObjectAccessException
{
     ...
     */
    public ObjectCloningException(final String objectId, final Throwable cause)
    {
     ...
     */
    public ObjectCloningException(final String objectId, final String message, final Throwable cause)
    {
        super(message, cause);
        this.objectId = objectId;
    }
    ...
    {
        return "Object " + objectId + " could not be cloned";
    }
