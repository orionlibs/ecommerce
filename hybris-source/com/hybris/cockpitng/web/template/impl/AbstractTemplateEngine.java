...
import com.hybris.cockpitng.web.template.TemplateEngine;
 ...
 *
 * @see com.hybris.cockpitng.core.util.template.impl.AbstractTemplateEngine
...
public abstract class AbstractTemplateEngine implements TemplateEngine
{
    ...
    @Override
    public InputStream applyTemplate(final Object context, final String templateId, final Map<String, Object> values) throws IOException
    {
    ...
    protected abstract InputStream applyTemplate(final Object context, final String templateId, final InputStream template, final Map<String, Object> values) throws IOException;
