...
@XmlType(name = "CreateSettings", propOrder = {"incomingEvents", "allIncomingEvents"})
public class CreateSettings
{
    ...
    @XmlAttribute(name = "reuseExisting")
    protected Boolean reuseExisting;
     ...
     *
     */
    public void setReuseExisting(final Boolean value)
    {
        this.reuseExisting = value;
    }
}
