...
@XmlType(name = "CloseSettings", propOrder = {"incomingEvents", "allIncomingEvents", "outgoingEvents", "allOutgoingEvents"})
public class CloseSettings
{
    ...
    @XmlElement(name = "outgoing-events")
    protected SocketEvents outgoingEvents;
    @XmlElement(name = "all-outgoing-events")
     ...
     *
     */
    public void setOutgoingEvents(final SocketEvents value)
    {
        this.outgoingEvents = value;
    }
     ...
     *
     */
    public void setAllOutgoingEvents(final AllSocketEvents value)
    {
        this.allOutgoingEvents = value;
    }
}
