...
public class CockpitConfigurationServiceExtender
{
    ...
    private Map<String, CockpitConfigurationAdapter<?>> originalConfigTypesAdapters = Collections.emptyMap();
    ...
    public void addAll()
    {
        ...
        if(MapUtils.isNotEmpty(this.configTypesAdapters))
        {
            this.originalConfigTypesAdapters = this.configurationService.getConfigTypesAdapters();
            this.configurationService.setConfigTypesAdapters(add(this.originalConfigTypesAdapters, this.configTypesAdapters));
        }
        if(this.configContextDecoratorList != null && CollectionUtils.isNotEmpty(this.contextDecorators))
        {
            this.originalContextDecorators = new ArrayList<>(this.configContextDecoratorList);
    ...
    public void removeAll()
    {
        ...
        if(MapUtils.isNotEmpty(this.configTypesAdapters))
        {
            this.configurationService.setConfigTypesAdapters(remove(this.configurationService.getConfigTypesAdapters(),
                            this.configTypesAdapters, this.originalConfigTypesAdapters));
        }
        if(this.configContextDecoratorList != null && CollectionUtils.isNotEmpty(this.contextDecorators))
        {
     ...
     *
     * @param configTypesAdapters
     *           adapters per config type.
     */
