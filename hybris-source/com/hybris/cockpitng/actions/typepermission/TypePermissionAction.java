 ...
 */
package com.hybris.cockpitng.actions.typepermission;
...
public class TypePermissionAction extends AbstractComponentWidgetAdapterAware implements CockpitAction<Object, Object>
{
    public static final String SOCKET_OUT_CURRENT_TYPE = "currentType";
    @Resource
    ...
    public ActionResult<Object> perform(final ActionContext<Object> ctx)
    {
        ...
        if(ctx.getData() != null)
        {
            sendOutput(SOCKET_OUT_CURRENT_TYPE, ctx.getData());
    ...
    {
        return ctx.getData() != null && getCockpitUserService().isAdmin(getCockpitUserService().getCurrentUser());
    }
