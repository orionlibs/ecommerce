...
class HsqlStrategy extends AbstractStrategy
{
    public HsqlStrategy(PersistenceInformation persistenceInfo, String columnName, String defaultValue)
    {
    ...
    {
        DDLStatement dDLStatement = new DDLStatement("alter table " + getDeploymentsTableName() + " alter column " + getColumnName() + " set not null");
        return (Iterable<SqlStatement>)ImmutableList.of(dDLStatement);
    }
