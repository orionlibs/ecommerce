...
public abstract class GeneratedScriptChangeConsumptionJob extends AbstractChangeProcessorJob
{
    ...
    static
    {
        Map<String, Item.AttributeMode> tmp = new HashMap<>(AbstractChangeProcessorJob.DEFAULT_INITIAL_ATTRIBUTES);
