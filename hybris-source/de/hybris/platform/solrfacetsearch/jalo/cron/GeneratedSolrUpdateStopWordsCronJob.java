...
public abstract class GeneratedSolrUpdateStopWordsCronJob extends CronJob
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedSolrUpdateStopWordsCronJob> SOLRFACETSEARCHCONFIGHANDLER = new BidirectionalOneToManyHandler(GeneratedSolrfacetsearchConstants.TC.SOLRUPDATESTOPWORDSCRONJOB, false, "solrFacetSearchConfig", "solrFacetSearchConfigPOS", true, true, 2);
