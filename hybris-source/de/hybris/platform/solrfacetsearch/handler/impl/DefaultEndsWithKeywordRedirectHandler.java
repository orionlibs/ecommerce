...
public class DefaultEndsWithKeywordRedirectHandler implements KeywordRedirectHandler
{
    ...
    public boolean keywordMatches(String theQuery, String keyword, boolean ignoreCase)
    {
        if(ignoreCase)
        {
            ...
            return theQuery.toLowerCase(currentLocale).endsWith(keyword.toLowerCase(currentLocale));
        }
        return theQuery.endsWith(keyword);
    }
