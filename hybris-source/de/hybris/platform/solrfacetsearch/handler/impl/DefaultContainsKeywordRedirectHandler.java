...
public class DefaultContainsKeywordRedirectHandler implements KeywordRedirectHandler
{
    ...
    public boolean keywordMatches(String theQuery, String keyword, boolean ignoreCase)
    {
        if(ignoreCase)
        {
            ...
            return theQuery.toLowerCase(currentLocale).contains(keyword.toLowerCase(currentLocale));
        }
        return theQuery.contains(keyword);
    }
