...
public class SolrUpdateStopWordsCronJobModel extends CronJobModel
{
    ...
    public SolrUpdateStopWordsCronJobModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public SolrUpdateStopWordsCronJobModel(JobModel _job, SolrFacetSearchConfigModel _solrFacetSearchConfig)
    {
        setJob(_job);
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public SolrUpdateStopWordsCronJobModel(JobModel _job, ItemModel _owner, SolrFacetSearchConfigModel _solrFacetSearchConfig)
    {
        setJob(_job);
        setOwner(_owner);
        setSolrFacetSearchConfig(_solrFacetSearchConfig);
