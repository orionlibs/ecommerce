...
public class CustomerCouponNotificationPopulator implements Populator<CouponNotificationModel, CustomerCouponNotificationData>
{
    ...
    public void populate(CouponNotificationModel source, CustomerCouponNotificationData target)
    {
        ...
        target.setCoupon((CustomerCouponData)getCustomerCouponConverter().convert(source.getCustomerCoupon()));
        target.setCustomer((CustomerData)getCustomerConverter().convert(source.getCustomer()));
