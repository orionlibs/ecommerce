package de.hybris.platform.hac.jalo;
...
@SLDSafe
public class HacManager extends Extension
{
    ...
    public static final HacManager getInstance()
    {
        ExtensionManager em = JaloSession.getCurrentSession().getExtensionManager();
        return (HacManager)em.getExtension("hac");
    }
