...
public class ConsignmentPrintPickSlipStrategy implements ConsignmentPrintDocumentStrategy
{
    protected static final String FRONTEND_TEMPLATENAME = "PickLabelDocumentTemplate";
    ...
    public void printDocument(ConsignmentModel consignmentModel)
    {
        ...
        MediaModel pickListMedia = getPrintMediaService().getMediaForTemplate("PickLabelDocumentTemplate",
