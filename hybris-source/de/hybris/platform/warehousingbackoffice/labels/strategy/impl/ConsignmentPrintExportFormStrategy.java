...
public class ConsignmentPrintExportFormStrategy implements ConsignmentPrintDocumentStrategy
{
    protected static final String FRONTEND_TEMPLATENAME = "ExportFormDocumentTemplate";
    ...
    public void printDocument(ConsignmentModel consignmentModel)
    {
        ...
        MediaModel pickListMedia = getPrintMediaService().getMediaForTemplate("ExportFormDocumentTemplate",
                        getConsignmentBusinessProcessService().getConsignmentProcess(consignmentModel));
        String popup = getPrintMediaService().generatePopupScriptForMedia(pickListMedia, "800", "800", resolveLabel("blockedpopupmessage"));
