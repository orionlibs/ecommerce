...
public class ConsignmentPrintReturnFormStrategy implements ConsignmentPrintDocumentStrategy
{
    ...
    public void printDocument(ConsignmentModel consignment)
    {
        ...
        {
            returnFormMedia = getPrintMediaService().getMediaForTemplate("ReturnFormDocumentTemplate",
                            getConsignmentBusinessProcessService().getConsignmentProcess(consignment));
            consignment.setReturnForm(returnFormMedia);
            getModelService().save(consignment);
        }
        String popup = getPrintMediaService().generatePopupScriptForMedia(returnFormMedia, "700", "700", resolveLabel("blockedpopupmessage"));
