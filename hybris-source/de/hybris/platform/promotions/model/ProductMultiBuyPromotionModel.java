...
public class ProductMultiBuyPromotionModel extends ProductPromotionModel
{
    ...
    public ProductMultiBuyPromotionModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public ProductMultiBuyPromotionModel(String _code)
    {
        setCode(_code);
    }
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public ProductMultiBuyPromotionModel(String _code, ItemModel _owner)
    {
        setCode(_code);
        setOwner(_owner);
    }
