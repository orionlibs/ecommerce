...
public class OrderThresholdDiscountPromotionModel extends OrderPromotionModel
{
    ...
    public OrderThresholdDiscountPromotionModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public OrderThresholdDiscountPromotionModel(String _code)
    {
        setCode(_code);
    }
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public OrderThresholdDiscountPromotionModel(String _code, ItemModel _owner)
    {
        setCode(_code);
        setOwner(_owner);
    }
    ...
    {
        return (Collection<PromotionPriceRowModel>)getPersistenceContext().getPropertyValue("discountPrices");
    }
    ...
    public void setDiscountPrices(Collection<PromotionPriceRowModel> value)
    {
