...
public class ProductBOGOFPromotionModel extends ProductPromotionModel
{
    ...
    public ProductBOGOFPromotionModel(String _code)
    {
        setCode(_code);
    }
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public ProductBOGOFPromotionModel(String _code, ItemModel _owner)
    {
        setCode(_code);
        setOwner(_owner);
    }
    ...
    {
        return (Integer)getPersistenceContext().getPropertyValue("freeCount");
    }
