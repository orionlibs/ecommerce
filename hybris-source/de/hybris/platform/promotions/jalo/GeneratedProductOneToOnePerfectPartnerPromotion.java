...
public abstract class GeneratedProductOneToOnePerfectPartnerPromotion extends ProductPromotion
{
    ...
    static
    {
        ...
        tmp.put("partnerProduct", Item.AttributeMode.INITIAL);
    ...
    public String getMessageCouldHaveFired(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedProductOneToOnePerfectPartnerPromotion.getMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public void setMessageCouldHaveFired(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedProductOneToOnePerfectPartnerPromotion.setMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public String getMessageFired(SessionContext ctx)
    {
        if(ctx == null || ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedProductOneToOnePerfectPartnerPromotion.getMessageFired requires a session language", 0);
        }
    ...
    public void setMessageFired(SessionContext ctx, String value)
    {
        ...
        if(ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedProductOneToOnePerfectPartnerPromotion.setMessageFired requires a session language", 0);
        }
    ...
    {
        return (Product)getProperty(ctx, "partnerProduct");
    }


    public Product getPartnerProduct()
    {
        return getPartnerProduct(getSession().getSessionContext());
    }


    public void setPartnerProduct(SessionContext ctx, Product value)
    {
        setProperty(ctx, "partnerProduct", value);
    }


    public void setPartnerProduct(Product value)
    {
        setPartnerProduct(getSession().getSessionContext(), value);
    }


    public abstract Product getBaseProduct(SessionContext paramSessionContext);


    public abstract void setBaseProduct(SessionContext paramSessionContext, Product paramProduct);
}
