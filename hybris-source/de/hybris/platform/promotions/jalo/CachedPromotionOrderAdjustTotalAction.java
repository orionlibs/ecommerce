...
public class CachedPromotionOrderAdjustTotalAction extends GeneratedCachedPromotionOrderAdjustTotalAction implements JaloOnlyItem
{
    private static final Logger LOG = Logger.getLogger(CachedPromotionOrderAdjustTotalAction.class.getName());
    ...
    protected Item createItem(SessionContext ctx, ComposedType type, Item.ItemAttributeMap allAttributes) throws JaloBusinessException
    {
        ...
        Class<CachedPromotionOrderAdjustTotalAction> cl = type.getJaloClass();
        try
        {
            CachedPromotionOrderAdjustTotalAction newOne = cl.newInstance();
    ...
    protected AbstractPromotionAction deepClone(SessionContext ctx)
    {
        try
        {
            ...
            ComposedType type = TypeManager.getInstance().getComposedType(PromotionOrderAdjustTotalAction.class);
            try
            {
