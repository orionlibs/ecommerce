...
public abstract class GeneratedOrderThresholdFreeVoucherPromotion extends OrderPromotion
{
    ...
    static
    {
        ...
        tmp.put("freeVoucher", Item.AttributeMode.INITIAL);
    ...
    {
        return (Voucher)getProperty(ctx, "freeVoucher");
    }


    public Voucher getFreeVoucher()
    {
        return getFreeVoucher(getSession().getSessionContext());
    }


    public void setFreeVoucher(SessionContext ctx, Voucher value)
    {
        setProperty(ctx, "freeVoucher", value);
    }


    public void setFreeVoucher(Voucher value)
    {
        setFreeVoucher(getSession().getSessionContext(), value);
    }
    ...
    public String getMessageCouldHaveFired(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedOrderThresholdFreeVoucherPromotion.getMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public void setMessageCouldHaveFired(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedOrderThresholdFreeVoucherPromotion.setMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public String getMessageFired(SessionContext ctx)
    {
        if(ctx == null || ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedOrderThresholdFreeVoucherPromotion.getMessageFired requires a session language", 0);
        }
    ...
    public void setMessageFired(SessionContext ctx, String value)
    {
        ...
        if(ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedOrderThresholdFreeVoucherPromotion.setMessageFired requires a session language", 0);
        }
