...
public abstract class GeneratedOrderThresholdFreeGiftPromotion extends OrderPromotion
{
    ...
    static
    {
        ...
        tmp.put("giftProduct", Item.AttributeMode.INITIAL);
    ...
    public Product getGiftProduct(SessionContext ctx)
    {
    ...
    public void setGiftProduct(SessionContext ctx, Product value)
    {
        setProperty(ctx, "giftProduct", value);
    }


    public void setGiftProduct(Product value)
    {
    ...
    public String getMessageCouldHaveFired(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedOrderThresholdFreeGiftPromotion.getMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public void setMessageCouldHaveFired(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedOrderThresholdFreeGiftPromotion.setMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public String getMessageFired(SessionContext ctx)
    {
        if(ctx == null || ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedOrderThresholdFreeGiftPromotion.getMessageFired requires a session language", 0);
        }
    ...
    public void setMessageFired(SessionContext ctx, String value)
    {
        ...
        if(ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedOrderThresholdFreeGiftPromotion.setMessageFired requires a session language", 0);
        }
