...
public abstract class GeneratedProductPerfectPartnerPromotion extends ProductPromotion
{
    ...
    static
    {
        ...
        tmp.put("partnerProducts", Item.AttributeMode.INITIAL);
        tmp.put("partnerPrices", Item.AttributeMode.INITIAL);
    ...
    public String getMessageCouldHaveFired(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedProductPerfectPartnerPromotion.getMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public void setMessageCouldHaveFired(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedProductPerfectPartnerPromotion.setMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public String getMessageFired(SessionContext ctx)
    {
        if(ctx == null || ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedProductPerfectPartnerPromotion.getMessageFired requires a session language", 0);
        }
    ...
    public void setMessageFired(SessionContext ctx, String value)
    {
        ...
        if(ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedProductPerfectPartnerPromotion.setMessageFired requires a session language", 0);
        }
    ...
    {
        Collection<PromotionPriceRow> coll = (Collection<PromotionPriceRow>)getProperty(ctx, "partnerPrices");
    ...
    {
        return getPartnerPrices(getSession().getSessionContext());
    }
    ...
    {
        setPartnerPrices(getSession().getSessionContext(), value);
    }
