...
public class CachedPromotionNullAction extends GeneratedCachedPromotionNullAction implements JaloOnlyItem
{
    ...
    protected Item createItem(SessionContext ctx, ComposedType type, Item.ItemAttributeMap allAttributes) throws JaloBusinessException
    {
        ...
        Class<CachedPromotionNullAction> cl = type.getJaloClass();
        try
        {
            CachedPromotionNullAction newOne = cl.newInstance();
