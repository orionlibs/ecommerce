...
public abstract class GeneratedProductPerfectPartnerBundlePromotion extends ProductPromotion
{
    ...
    public String getMessageCouldHaveFired(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedProductPerfectPartnerBundlePromotion.getMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public void setMessageCouldHaveFired(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedProductPerfectPartnerBundlePromotion.setMessageCouldHaveFired requires a session language", 0);
        }
    ...
    public String getMessageFired(SessionContext ctx)
    {
        if(ctx == null || ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedProductPerfectPartnerBundlePromotion.getMessageFired requires a session language", 0);
        }
    ...
    public void setMessageFired(SessionContext ctx, String value)
    {
        ...
        if(ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedProductPerfectPartnerBundlePromotion.setMessageFired requires a session language", 0);
        }
