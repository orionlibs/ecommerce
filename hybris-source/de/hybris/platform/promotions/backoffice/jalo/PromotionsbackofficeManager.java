 ...
 */
public class PromotionsbackofficeManager extends GeneratedPromotionsbackofficeManager
{
    /** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
    private static final Logger LOG = Logger.getLogger(PromotionsbackofficeManager.class.getName());
     ...
     */
    public PromotionsbackofficeManager()
    {
        if(LOG.isDebugEnabled())
        {
            LOG.debug("constructor of PromotionsbackofficeManager called.");
        }
    }
     ...
     */
    public static PromotionsbackofficeManager getInstance()
    {
        return (PromotionsbackofficeManager)Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                        .getExtension(PromotionsbackofficeConstants.EXTENSIONNAME);
    }
