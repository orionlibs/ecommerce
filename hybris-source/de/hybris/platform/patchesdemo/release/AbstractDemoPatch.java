...
public abstract class AbstractDemoPatch extends AbstractPatch implements DemoPatch
{
    ...
    public AbstractDemoPatch(final String patchId, final String patchName, final Release release,
    ...
    private void createCountriesData(final StructureState structureState, final boolean update)
    {
        ...
        {
            if(country.getStructureState() == structureState || (!update && !country.getStructureState()
                            .isAfter(structureState)))
            {
