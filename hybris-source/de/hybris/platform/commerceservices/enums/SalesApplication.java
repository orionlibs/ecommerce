...
{
    public static final String _TYPECODE = "SalesApplication";
    public static final String SIMPLE_CLASSNAME = "SalesApplication";
    private static final ConcurrentMap<String, SalesApplication> cache = new ConcurrentHashMap<>();
    ...
    private SalesApplication(String code)
    {
    ...
    public static SalesApplication valueOf(String code)
    {
