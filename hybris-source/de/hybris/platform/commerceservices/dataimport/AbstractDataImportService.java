...
public abstract class AbstractDataImportService
{
                    ...
                    final ImportData importData, final boolean syncCatalogs)
    {
        ...
        for(final String storeName : importData.getStoreNames())
        {
            ...
            systemSetup.logInfo(context, String.format("Begin importing search services index data for [%s]", storeName));
            importSearchServicesIndex(context.getExtensionName(), storeName);
