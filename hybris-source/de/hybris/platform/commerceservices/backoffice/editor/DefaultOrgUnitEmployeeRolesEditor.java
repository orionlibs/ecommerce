...
public class DefaultOrgUnitEmployeeRolesEditor extends DefaultEditorAreaPanelRenderer
{
    public void render(Component parent, AbstractPanel panel, Object object, DataType dataType, WidgetInstanceManager widgetInstanceManager)
    {
        if(object instanceof de.hybris.platform.core.model.user.EmployeeModel)
        {
            ...
            UITools.modifySClass((HtmlBasedComponent)parentWrapper, "yw-editorarea-org-roles-wrapper", true);
            ...
            addtional.appendChild((Component)new Label(Labels.getLabel("organization.sales.employee.roles")));
