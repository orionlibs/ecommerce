...
public class DefaultCommerceAddToCartStrategy extends AbstractCommerceAddToCartStrategy
{
    ...
    protected void mergeEntry(@Nonnull final CommerceCartModification modification, @Nonnull final CommerceCartParameter parameter) throws CommerceCartModificationException
    {
