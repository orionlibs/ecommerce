...
public interface CommerceCartService
{
     ...
     *           the quantity to add
     * @param unit
     *           the UnitModel of the product @see {@link de.hybris.platform.core.model.product.ProductModel#getUnit()}
     * @param forceNewEntry
     *           the flag for creating a new {@link de.hybris.platform.core.model.order.CartEntryModel}
    ...
    /**
     * @deprecated Since 5.2. Use
     *             {@link #validateCart(de.hybris.platform.commerceservices.service.data.CommerceCartParameter)}
     *
     * @param cartModel
     *           the user's cart in session
    ...
    /**
     * @deprecated Since 5.2. Use
     *             {@link #removeAllEntries(de.hybris.platform.commerceservices.service.data.CommerceCartParameter)}
     *             instead
     *
     * @param cartModel
     *           the user's cart in session
    ...
    /**
     * @deprecated Since 5.2. Use
     *             {@link #restoreCart(de.hybris.platform.commerceservices.service.data.CommerceCartParameter)}
     *
     * @param oldCart
     ...
     * @deprecated Since 5.2. Use
     *             {@link #estimateTaxes(de.hybris.platform.commerceservices.service.data.CommerceCartParameter)}
     *             instead.
     */
    @Deprecated(since = "5.2", forRemoval = true)
     ...
     *           </ul>
     * @throws CommerceCartModificationException
     *            if product is not configurable or {@code entry} is invalid
     * @throws IllegalArgumentException
     *            if {@code configuration} contains
     */
     ...
     *
     * @param parameters
     *           a parameter object containing all attributes needed for remove group from the cart
     *           <ul>
     ...
     */
    @Nonnull
    CommerceCartModification removeEntryGroup(@Nonnull RemoveEntryGroupParameter parameters)
                    throws CommerceCartModificationException;
}
