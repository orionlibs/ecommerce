...
public class DefaultProductModelUrlResolver extends AbstractUrlResolver<ProductModel>
{
    ...
    protected String resolveInternal(final ProductModel source)
    {
        ...
        if(url.contains("{product-code}"))
        {
            ...
            // - Most people ignore that "+" is allowed in a path part and that it designated the plus character and
            //   not a space. There are other surprises:
            //
            ...
            // bottom line: we should have %20 before the ? and + after for whitespaces.
            final String productCode = urlEncode(source.getCode()).replace("+", "%20");
