...
/**
 * In contrast to this simplified implementation {@link DefaultCartValidationStrategy} is aware of
 * {@link CartValidationHook}s, so that the validation result will also cover logic placed in hook implementations.
 *
 * @deprecated since 2011. Please use {@link DefaultCartValidationStrategy} instead
 */
