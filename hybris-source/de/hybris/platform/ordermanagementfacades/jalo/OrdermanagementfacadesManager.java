 ...
 */
public class OrdermanagementfacadesManager extends GeneratedOrdermanagementfacadesManager
{
    /**
     * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
     */
    private static final Logger LOG = LoggerFactory.getLogger(OrdermanagementfacadesManager.class.getName());
     ...
     */
    public static OrdermanagementfacadesManager getInstance()
    {
        return (OrdermanagementfacadesManager)Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                        .getExtension(OrdermanagementfacadesConstants.EXTENSIONNAME);
    }
     ...
     */
    public OrdermanagementfacadesManager() // NOPMD
    {
        if(LOG.isDebugEnabled())
        {
            LOG.debug("constructor of OrdermanagementfacadesManager called.");
        }
    }
