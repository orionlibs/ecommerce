...
public interface BundleRuleService
{
     ...
     * the context of the given <code>entryGroup</code> and <code>bundleTemplate</code>.
     *
     ...
     *           {@link DisableProductBundleRuleModel}'s are searched
     * @param entryGroup
     *           entry group based on which the given <code>product</code> is or shall be added to the bundle
    ...
    DisableProductBundleRuleModel getDisableRuleForBundleProduct(@Nonnull final AbstractOrderModel masterAbstractOrder,
                    ...
                    @Nonnull final EntryGroup entryGroup,
