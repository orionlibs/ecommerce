...
public class ProductTextfieldConfiguratorController extends AbstractPageController
{
    ...
    @RequestMapping(value = "/**/p/{productCode}/configuratorPage/" + TEXTFIELDCONFIGURATOR_TYPE, method =
                    {RequestMethod.GET})
    public String productConfiguratorGet(@PathVariable("productCode") final String encodedProductCode, final Model model, final ConfigureForm configureForm) throws CMSItemNotFoundException
    {
    ...
    public String productConfiguratorPost(@PathVariable("productCode") final String encodedProductCode, final Model model, final ConfigureForm configureForm) throws CMSItemNotFoundException
    {
        return productConfigurator(encodedProductCode, model, configureForm);
    }
    ...
    public String addToCart(@PathVariable("productCode") final String encodedProductCode, final Model model, @ModelAttribute("foo")
                    @Valid final TextFieldConfigurationForm form, final BindingResult bindingErrors, final HttpServletRequest request,
    ...
    public String editConfigurationInEntry(@PathVariable(MODEL_ATTR_ENTRY_NUMBER) final int entryNumber, final Model model) throws CMSItemNotFoundException, CommerceCartModificationException
    {
    ...
    public String updateConfigurationInEntry(@PathVariable(MODEL_ATTR_ENTRY_NUMBER) final int entryNumber, final Model model, @ModelAttribute("foo")
                    @Valid final TextFieldConfigurationForm form, final BindingResult bindingErrors, final HttpServletRequest request,
    ...
    public String displayConfigurationInQuoteEntry(@PathVariable("quoteCode") final String quoteCode, @PathVariable(MODEL_ATTR_ENTRY_NUMBER) final int entryNumber, final Model model) throws CMSItemNotFoundException, CommerceCartModificationException
    {
    ...
    public String displayConfigurationInOrderEntry(@PathVariable("orderCode") final String orderCode, @PathVariable(MODEL_ATTR_ENTRY_NUMBER) final int entryNumber, final Model model) throws CMSItemNotFoundException, CommerceCartModificationException
    {
    ...
    public String displayConfigurationInSavedCartEntry(@PathVariable("cartCode") final String cartCode, @PathVariable(MODEL_ATTR_ENTRY_NUMBER) final int entryNumber, final Model model)
