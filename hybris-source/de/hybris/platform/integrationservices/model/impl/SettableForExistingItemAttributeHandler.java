...
class SettableForExistingItemAttributeHandler implements SettableAttributeHandler
{
    private final ModelService modelService;


    public SettableForExistingItemAttributeHandler(final ModelService modelService)
    {
