                ...
                implements IntegrationKeyValueGenerator<TypeDescriptor, IntegrationItem>
{
    ...
    private IntegrationKeyValueGenerator<TypeDescriptor, Map<String, Object>> getMapToIntegrationKeyGenerator()
    {
    ...
    private IntegrationItemToMapConverter getIntegrationItemToMapConverter()
    {
