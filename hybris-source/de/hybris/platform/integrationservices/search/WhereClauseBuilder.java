...
class WhereClauseBuilder
{
    ...
    private void validateFilterDoesNotContainVirtualAttributesInConditions()
    {
        filter.getConditions().stream()
                        ...
                        .map(Optional::get)
                        .findFirst()
                        .ifPresent(virtualAttribute -> {
                            throw new FilterByVirtualAttributeNotSupportedException(virtualAttribute);
                        });
    }
    ...
    private void validateFilterDoesNotContainClassificationAttributesInConditions()
    {
        filter.getConditions().stream()
                        ...
                        .map(Optional::get)
                        .findFirst()
                        .ifPresent(classificationAttr -> {
                            throw new FilterByClassificationAttributeNotSupportedException(classificationAttr);
                        });
    }
