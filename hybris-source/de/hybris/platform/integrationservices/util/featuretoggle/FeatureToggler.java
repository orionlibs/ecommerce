...
public class FeatureToggler
{
     ...
     * @param feature Feature to turn on
     */
    public static void enable(final Feature feature)
    {
        getConfigurationService().getConfiguration().setProperty(feature.getProperty(), "true");
    }


    /**
     * Turns off the feature
     * @param feature Feature to turn off
     */
    public static void disable(final Feature feature)
    {
        getConfigurationService().getConfiguration().setProperty(feature.getProperty(), "false");
    }
