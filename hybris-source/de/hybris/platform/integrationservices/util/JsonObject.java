...
public class JsonObject
{
    ...
    private static final String PATH_NOT_FOUND_MSG = "Path {} not found";
     ...
     *
     * @return {@code true}, if this object represents an empty JSON, e.g. {@code "{}"}; {@code false}, if the object
     * contains at least one nested element.
     */
