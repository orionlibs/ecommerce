...
public class GroupCartModificationListPopulator implements Populator<AbstractOrderModel, List<CartModificationData>>
{
                    ...
                    final OrderEntryData groupedEntry)
    {
        ...
        {
            if(groupedModification.getEntry().getEntryNumber().equals(groupedEntry.getEntryNumber()))
            {
    ...
    protected OrderEntryData getGroupedEntry(final List<OrderEntryData> groupedEntries, final OrderEntryData entryToFind)
    {
        for(final OrderEntryData groupedEntry : groupedEntries)
        {
            if(groupedEntry.getEntries() != null)
            {
                ...
                {
                    if(entry.getEntryNumber().equals(entryToFind.getEntryNumber()))
                    {
                        return groupedEntry;
                    }
                }
    ...
    @Required
    public void setGroupOrderEntryConverter(final Converter<AbstractOrderModel, AbstractOrderData> groupOrderEntryConverter)
    {
