...
public interface AnonymousConsentFacade
{
    ...
    /**
     * Enables populating consents flag in commerceservices
     *
     * @param populatingConsentsEnabled
     */
    default void setPopulatingConsentsEnabled(final boolean populatingConsentsEnabled)
    {
