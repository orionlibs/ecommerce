...
public class SearchResultVariantOptionsProductPopulator extends SearchResultVariantProductPopulator
{
    ...
    public static final String PRICE_VARIANT_PROPERTY = "price";
    ...
    @Override
    protected Double resolvePrice(final SearchResultValueData source)
    {
        final Object priceValue = getValue(source, PRICE_VALUE_VARIANT_PROPERTY);
        if(priceValue instanceof Double)
        {
            return (Double)priceValue;
        }
        final Object price = getValue(source, PRICE_VARIANT_PROPERTY);
