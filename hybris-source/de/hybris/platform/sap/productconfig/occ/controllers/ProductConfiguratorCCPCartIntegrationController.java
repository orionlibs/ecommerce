...
public class ProductConfiguratorCCPCartIntegrationController
{
    ...
    public CartModificationWsDTO updateCartEntry(@ApiParam(value = "Base site identifier.")
                    ...
                    @PathVariable final int entryNumber, @ApiParam(value = "Product configuration order entry with config id and order entry attributes")
                    @RequestBody(required = true) final ProductConfigOrderEntryWsDTO entry)
    {
