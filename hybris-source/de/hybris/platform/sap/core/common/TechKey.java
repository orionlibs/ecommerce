...
public final class TechKey implements Serializable
{
    ...
    public String toUUIDString()
    {
        ...
        stringBuilder.append(id, UUID_FIRST_PART_START_INDEX, UUID_FIRST_PART_END_INDEX).append("-").append(id, UUID_SECOND_PART_START_INDEX, UUID_SECOND_PART_END_INDEX).append("-").append(id, UUID_THIRD_PART_START_INDEX, UUID_THIRD_PART_END_INDEX).append("-")
                        .append(id, UUID_FOURTH_PART_START_INDEX, UUID_FOURTH_PART_END_INDEX)
