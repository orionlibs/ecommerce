...
public class SAPHybrisSessionProvider extends AbstractEventListener<BeforeSessionCloseEvent>
{
     ...
     */
    protected final Set<SAPHybrisSessionEventListener> eventListener = new ConcurrentHashSet<>(); //NOPMD
    /**
     * Session which are about to be deleted.
     */
    protected final Map<Session, SAPHybrisSession> sessionsToBeDeleted = new ConcurrentHashMap<>(); //NOPMD
