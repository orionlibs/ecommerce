...
public class DefaultInboundQuoteHelper implements InboundQuoteHelper
{
    ...
    public static final int C4C_TO_HYBRIS_CODE_CONVERTER = 10;
    ...
    public String getNameForQuote(String code)
    {
        ...
        {
            LOG.info("No existing quote found with this code in getNameForQuote() {} ", code);
    ...
    public String getPreviousEstimatedTotal(String code)
    {
        ...
        {
            LOG.info("No existing quote found with this code in getPreviousEstimatedTotal() - " + code);
    ...
    public String getGuid(String code)
    {
        ...
        {
            LOG.info("No existing quote found with this code in getGuid Method {}", code);
    ...
    {
        return Integer.toString(Integer.parseInt(code) / C4C_TO_HYBRIS_CODE_CONVERTER - 1);
    }
