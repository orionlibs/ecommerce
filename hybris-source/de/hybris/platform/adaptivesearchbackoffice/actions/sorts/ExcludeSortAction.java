...
public class ExcludeSortAction extends AbstractComponentWidgetAdapterAware implements CockpitAction<AbstractEditorData, Object>
{
    ...
    public ActionResult<Object> perform(ActionContext<AbstractEditorData> ctx)
    {
        ...
        {
            this.asConfigurationService.moveConfiguration((AbstractAsConfigurationModel)searchConfiguration, "promotedSorts", "excludedSorts", sort.getUid());
        }
        else if(sort instanceof de.hybris.platform.adaptivesearch.model.AsSortModel)
        {
            this.asConfigurationService.moveConfiguration((AbstractAsConfigurationModel)searchConfiguration, "sorts", "excludedSorts", sort.getUid());
        }
        else
        {
    ...
    public boolean canPerform(ActionContext<AbstractEditorData> ctx)
    {
        ...
        if(!(model instanceof de.hybris.platform.adaptivesearch.model.AsPromotedSortModel) && !(model instanceof de.hybris.platform.adaptivesearch.model.AsSortModel))
        {
            return false;
        }
