...
public class BeanshellCodeLine extends AbstractScriptingEngineCodeLine
{
    ...
    public BeanshellCodeLine(Map<Integer, String> csvLine, String marker, String scriptContent, int lineNumber, String location, String scriptingEngineName, ScriptingLanguagesService service)
    {
