...
public class OrgUnitAdministratorsDisplayStrategy implements OrgUnitUsersDisplayStrategy
{
                    ...
                    final String unitId)
    {
        ...
        return getB2bUnitFacade().getPagedAdministratorsForUnit(pageableData, unitId);
    }
