...
public class RuleActionDefinitionModel extends ItemModel
{
    ...
    {
        return (List<RuleActionDefinitionCategoryModel>)getPersistenceContext().getPropertyValue("categories");
    }
    ...
    {
        return (List<RuleActionDefinitionParameterModel>)getPersistenceContext().getPropertyValue("parameters");
    }
    ...
    {
        return (List<RuleActionDefinitionRuleTypeMappingModel>)getPersistenceContext().getPropertyValue("ruleTypes");
    }
    ...
    public void setCategories(List<RuleActionDefinitionCategoryModel> value)
    {
    ...
    public void setParameters(List<RuleActionDefinitionParameterModel> value)
    {
    ...
    public void setRuleTypes(List<RuleActionDefinitionRuleTypeMappingModel> value)
    {
