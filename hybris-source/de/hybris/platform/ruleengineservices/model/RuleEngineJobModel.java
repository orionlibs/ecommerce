...
public class RuleEngineJobModel extends ServicelayerJobModel
{
    ...
    public RuleEngineJobModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public RuleEngineJobModel(String _code, String _springId)
    {
        setCode(_code);
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public RuleEngineJobModel(String _code, Integer _nodeID, ItemModel _owner, String _springId)
    {
        setCode(_code);
        setNodeID(_nodeID);
        setOwner(_owner);
