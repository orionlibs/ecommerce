...
public class RuleSubsetOrderEntryFixedDiscountRAOAction extends AbstractRuleSubsetProductAction
{
    ...
    public static final String DISTRIBUTE_STRATEGY = "distribute_strategy";
    ...
    {
        return (EntriesDiscountDistributeStrategy)getTargetEntriesDiscountDistributeStrategy().get(FixedDiscountDistributeStrategy.UNIFORM);
    }


    protected boolean performActionInternal(RuleActionContext context)
    {
        BigDecimal discount = (BigDecimal)context.getParameter("value");
        ...
        FixedDiscountDistributeStrategy distributeStrategy = (FixedDiscountDistributeStrategy)context.getParameter("distribute_strategy");
        ...
        return performAction(context, qualifyOrderEntries, targetOrderEntries, discount, selectCurrency, distributeStrategy);
    }
    ...
    protected boolean performAction(RuleActionContext context, Set<OrderEntryRAO> qualifyEntries, Set<OrderEntryRAO> targetEntries, BigDecimal discountValueForCartCurrency, String currencyISOCode, FixedDiscountDistributeStrategy distributeStrategy)
    {
        ...
        if(!targetEntries.isEmpty())
        {
            ...
            List<DiscountRAO> discounts = addDiscountOnMultipleOrderEntryLevelAndConsume(context, (List)targetEntries
                            .stream().collect(Collectors.toUnmodifiableList()), true, discountValueForCartCurrency, currencyISOCode, distributeStrategy, result);
