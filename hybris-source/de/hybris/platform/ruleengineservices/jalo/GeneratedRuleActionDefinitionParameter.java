...
public abstract class GeneratedRuleActionDefinitionParameter extends GenericItem
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedRuleActionDefinitionParameter> DEFINITIONHANDLER = new BidirectionalOneToManyHandler(GeneratedRuleEngineServicesConstants.TC.RULEACTIONDEFINITIONPARAMETER, false, "definition", "definitionPOS", true, true, 2);
    ...
    public String getDescription(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedRuleActionDefinitionParameter.getDescription requires a session language", 0);
        }
    ...
    public void setDescription(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedRuleActionDefinitionParameter.setDescription requires a session language", 0);
        }
    ...
    public String getName(SessionContext ctx)
    {
        if(ctx == null || ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedRuleActionDefinitionParameter.getName requires a session language", 0);
        }
    ...
    public void setName(SessionContext ctx, String value)
    {
        ...
        if(ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedRuleActionDefinitionParameter.setName requires a session language", 0);
        }
