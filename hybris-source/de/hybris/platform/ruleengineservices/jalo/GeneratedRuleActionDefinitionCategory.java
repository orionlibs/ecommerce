...
public abstract class GeneratedRuleActionDefinitionCategory extends GenericItem
{
    ...
    public List<RuleActionDefinition> getDefinitions(SessionContext ctx)
    {
        List<RuleActionDefinition> items = getLinkedItems(ctx, false, GeneratedRuleEngineServicesConstants.Relations.RULEACTIONDEFINITION2CATEGORYRELATION, "RuleActionDefinition", null,
    ...
    public List<RuleActionDefinition> getDefinitions()
    {
    ...
    {
        return getLinkedItemsCount(ctx, false, GeneratedRuleEngineServicesConstants.Relations.RULEACTIONDEFINITION2CATEGORYRELATION, "RuleActionDefinition", null);
    }
    ...
    public void setDefinitions(SessionContext ctx, List<RuleActionDefinition> value)
    {
        setLinkedItems(ctx, false, GeneratedRuleEngineServicesConstants.Relations.RULEACTIONDEFINITION2CATEGORYRELATION, null, value,
                        Utilities.getRelationOrderingOverride(RULEACTIONDEFINITION2CATEGORYRELATION_SRC_ORDERED, true),
                        Utilities.getRelationOrderingOverride(RULEACTIONDEFINITION2CATEGORYRELATION_TGT_ORDERED, true),
    ...
    public void setDefinitions(List<RuleActionDefinition> value)
    {
        setDefinitions(getSession().getSessionContext(), value);
    }


    public void addToDefinitions(SessionContext ctx, RuleActionDefinition value)
    {
        addLinkedItems(ctx, false, GeneratedRuleEngineServicesConstants.Relations.RULEACTIONDEFINITION2CATEGORYRELATION, null,
    ...
    public void addToDefinitions(RuleActionDefinition value)
    {
        addToDefinitions(getSession().getSessionContext(), value);
    }


    public void removeFromDefinitions(SessionContext ctx, RuleActionDefinition value)
    {
        removeLinkedItems(ctx, false, GeneratedRuleEngineServicesConstants.Relations.RULEACTIONDEFINITION2CATEGORYRELATION, null,
                        Collections.singletonList(value),
                        Utilities.getRelationOrderingOverride(RULEACTIONDEFINITION2CATEGORYRELATION_SRC_ORDERED, true),
                        Utilities.getRelationOrderingOverride(RULEACTIONDEFINITION2CATEGORYRELATION_TGT_ORDERED, true),
                        Utilities.getMarkModifiedOverride(RULEACTIONDEFINITION2CATEGORYRELATION_MARKMODIFIED));
    ...
    public void removeFromDefinitions(RuleActionDefinition value)
    {
    ...
    {
        ComposedType relationSecondEnd0 = TypeManager.getInstance().getComposedType("RuleActionDefinition");
    ...
    public String getName(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedRuleActionDefinitionCategory.getName requires a session language", 0);
        }
    ...
    public void setName(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedRuleActionDefinitionCategory.setName requires a session language", 0);
        }
