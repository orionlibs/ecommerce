...
public class AsSortsAddBeforeMergeStrategy extends AbstractAsSortsMergeStrategy
{
    ...
    protected <V extends AbstractAsSortConfiguration, C1 extends AbstractAsSortConfiguration, C2 extends AbstractAsSortConfiguration> void mergeBefore(Map<String, AsConfigurationHolder<V, AbstractAsSortConfiguration>> source, Map<String, AsConfigurationHolder<V, AbstractAsSortConfiguration>> target,
