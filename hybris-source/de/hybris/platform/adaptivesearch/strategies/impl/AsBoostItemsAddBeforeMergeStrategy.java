...
public class AsBoostItemsAddBeforeMergeStrategy extends AbstractAsBoostItemsMergeStrategy
{
    ...
    {
        mergeBefore(source.getPromotedItems(), target.getPromotedItems(), target.getExcludedItems());
        mergeBefore(source.getExcludedItems(), target.getExcludedItems(), target.getPromotedItems());
    }


    protected <V extends AbstractAsBoostItemConfiguration, C extends AbstractAsBoostItemConfiguration> void mergeBefore(Map<PK, AsConfigurationHolder<V, AbstractAsBoostItemConfiguration>> source, Map<PK, AsConfigurationHolder<V, AbstractAsBoostItemConfiguration>> target,
