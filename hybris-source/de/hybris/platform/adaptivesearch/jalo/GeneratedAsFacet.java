...
public abstract class GeneratedAsFacet extends AbstractAsFacetConfiguration
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedAsFacet> SEARCHCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler(GeneratedAdaptivesearchConstants.TC.ASFACET, false, "searchConfiguration", "searchConfigurationPOS", true, true, 2);
