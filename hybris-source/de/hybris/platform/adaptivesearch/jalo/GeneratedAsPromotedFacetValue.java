...
public abstract class GeneratedAsPromotedFacetValue extends AbstractAsFacetValueConfiguration
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedAsPromotedFacetValue> FACETCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler(GeneratedAdaptivesearchConstants.TC.ASPROMOTEDFACETVALUE, false, "facetConfiguration", "facetConfigurationPOS", true, true, 2);
