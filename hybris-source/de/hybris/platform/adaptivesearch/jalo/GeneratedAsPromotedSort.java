...
public abstract class GeneratedAsPromotedSort extends AbstractAsSortConfiguration
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedAsPromotedSort> SEARCHCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler(GeneratedAdaptivesearchConstants.TC.ASPROMOTEDSORT, false, "searchConfiguration", "searchConfigurationPOS", true, true, 2);
