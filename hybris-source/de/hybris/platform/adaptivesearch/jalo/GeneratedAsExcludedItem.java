...
public abstract class GeneratedAsExcludedItem extends AbstractAsBoostItemConfiguration
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedAsExcludedItem> SEARCHCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler(GeneratedAdaptivesearchConstants.TC.ASEXCLUDEDITEM, false, "searchConfiguration", "searchConfigurationPOS", true, true, 2);
