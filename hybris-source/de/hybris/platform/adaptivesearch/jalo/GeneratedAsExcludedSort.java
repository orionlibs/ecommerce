...
public abstract class GeneratedAsExcludedSort extends AbstractAsSortConfiguration
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedAsExcludedSort> SEARCHCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler(GeneratedAdaptivesearchConstants.TC.ASEXCLUDEDSORT, false, "searchConfiguration", "searchConfigurationPOS", true, true, 2);
