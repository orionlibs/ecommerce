...
public abstract class GeneratedAsExcludedFacet extends AbstractAsFacetConfiguration
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedAsExcludedFacet> SEARCHCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler(GeneratedAdaptivesearchConstants.TC.ASEXCLUDEDFACET, false, "searchConfiguration", "searchConfigurationPOS", true, true, 2);
