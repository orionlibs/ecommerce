...
public abstract class GeneratedAsPromotedItem extends AbstractAsBoostItemConfiguration
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedAsPromotedItem> SEARCHCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler(GeneratedAdaptivesearchConstants.TC.ASPROMOTEDITEM, false, "searchConfiguration", "searchConfigurationPOS", true, true, 2);
    protected static final Map<String, Item.AttributeMode> DEFAULT_INITIAL_ATTRIBUTES;

    static
    {
        Map<String, Item.AttributeMode> tmp = new HashMap<>(AbstractAsBoostItemConfiguration.DEFAULT_INITIAL_ATTRIBUTES);
