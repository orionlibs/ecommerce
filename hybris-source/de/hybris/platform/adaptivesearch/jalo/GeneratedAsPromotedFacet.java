...
public abstract class GeneratedAsPromotedFacet extends AbstractAsFacetConfiguration
{
    ...
    protected static final BidirectionalOneToManyHandler<GeneratedAsPromotedFacet> SEARCHCONFIGURATIONHANDLER = new BidirectionalOneToManyHandler(GeneratedAdaptivesearchConstants.TC.ASPROMOTEDFACET, false, "searchConfiguration", "searchConfigurationPOS", true, true, 2);
    protected static final Map<String, Item.AttributeMode> DEFAULT_INITIAL_ATTRIBUTES;

    static
    {
        Map<String, Item.AttributeMode> tmp = new HashMap<>(AbstractAsFacetConfiguration.DEFAULT_INITIAL_ATTRIBUTES);
