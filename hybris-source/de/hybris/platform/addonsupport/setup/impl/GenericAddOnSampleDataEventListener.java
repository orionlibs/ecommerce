...
public class GenericAddOnSampleDataEventListener extends AbstractEventListener<AbstractEvent>
{
    ...
    protected String createCacheKey(final AddonSampleDataImportedEvent event)
    {
        ...
        final Optional<String> importDataOpt = importData.getContentCatalogNames().stream().findFirst();
        final String contentCatalogName = importDataOpt.isPresent() ? importDataOpt.get() : StringUtils.EMPTY;
