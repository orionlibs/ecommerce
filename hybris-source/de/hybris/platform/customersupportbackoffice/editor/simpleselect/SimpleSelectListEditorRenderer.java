...
public class SimpleSelectListEditorRenderer<T> extends DefaultMultiReferenceEditor<T>
{
    private static final Logger LOG = LoggerFactory.getLogger(SimpleSelectListEditorRenderer.class);
