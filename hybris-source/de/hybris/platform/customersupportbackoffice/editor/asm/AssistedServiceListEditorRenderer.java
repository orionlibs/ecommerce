...
public class AssistedServiceListEditorRenderer<T> extends DefaultMultiReferenceEditor<T>
{
    private static final Logger LOG = LoggerFactory.getLogger(AssistedServiceListEditorRenderer.class);
    @Resource
