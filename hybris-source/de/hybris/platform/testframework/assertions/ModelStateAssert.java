...
public class ModelStateAssert extends GenericAssert<ModelStateAssert, AbstractItemModel>
{
    ...
    {
        super(ModelStateAssert.class, actual);
    }


    public static ModelStateAssert assertThat(AbstractItemModel model)
    {
    ...
    public ModelStateAssert hasFieldValueEqualTo(Object expectedValue)
    {
        ...
        ((ObjectAssert)Assertions.assertThat(fieldValue).isNotNull()).isEqualTo(expectedValue);
        return this;
    }
