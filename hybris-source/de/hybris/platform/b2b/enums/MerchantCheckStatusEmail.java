...
{
    public static final String _TYPECODE = "MerchantCheckStatusEmail";
    public static final String SIMPLE_CLASSNAME = "MerchantCheckStatusEmail";
    private static final ConcurrentMap<String, MerchantCheckStatusEmail> cache = new ConcurrentHashMap<>();
    ...
    private MerchantCheckStatusEmail(String code)
    {
    ...
    {
        return "MerchantCheckStatusEmail";
    }
    ...
    public static MerchantCheckStatusEmail valueOf(String code)
    {
