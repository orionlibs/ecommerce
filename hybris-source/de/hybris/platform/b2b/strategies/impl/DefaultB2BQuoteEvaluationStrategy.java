...
public class DefaultB2BQuoteEvaluationStrategy implements QuoteEvaluationStrategy
{
    ...
    public boolean isQuoteAllowed(final AbstractOrderModel source)
    {
        ...
        final BigDecimal orderTotalConvertedToLimitCurrency = BigDecimal.valueOf(getB2bCurrencyConversionService()
                        .convertAmount(source.getTotalPrice(), source.getCurrency(), applicableQuoteLimitCurrency));
