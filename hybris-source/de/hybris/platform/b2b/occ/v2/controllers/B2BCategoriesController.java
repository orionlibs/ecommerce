...
public class B2BCategoriesController extends BaseController
{
    ...
    @ResponseBody
    @ApiOperation(nickname = "getProductsByCategory", value = "Gets a list of products under a specific category", notes = "Returns a list of products in the specified category.")
    @ApiBaseSiteIdParam
