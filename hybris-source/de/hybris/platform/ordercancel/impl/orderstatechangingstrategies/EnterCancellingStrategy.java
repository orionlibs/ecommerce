...
public class EnterCancellingStrategy implements OrderStatusChangeStrategy
{
    ...
    {
        orderCancelRecordEntry.getModificationRecord().getOrder().setStatus(OrderStatus.CANCELLING);
        if(saveOrderModel)
        {
