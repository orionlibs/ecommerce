...
public class DuplicateAction extends AbstractListViewAction
{
    ...
    {
        return "productcockpit/images//icon_product_duplicate_off.gif";
    }
    ...
    {
        return Labels.getLabel("gridview.item.duplicate.tooltip");
    }
}
