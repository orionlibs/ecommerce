...
public class TypeController
{
    ...
    public ComponentTypeListData getAllComponentTypes( //
                    ...
                    @RequestParam(value = "readOnly", required = false, defaultValue = "false") final Boolean readOnly)
    {
    ...
    public ComponentTypeData getComponentTypeByCode( //
                    ...
                    @ApiParam(value = "Read only mode for attributes", defaultValue = "false")
                    @RequestParam(value = "readOnly", required = false, defaultValue = "false") final Boolean readOnly) throws ComponentTypeNotFoundException
    {
