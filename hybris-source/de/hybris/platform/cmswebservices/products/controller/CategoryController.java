...
public class CategoryController
{
    ...
    @PathVariable final String code) throws CMSItemNotFoundException, ConversionException
    {
    ...
    public CategoryDataListWsDTO findProductCategoriesByText(
                    ...
                    @RequestParam(required = false) final String text, @ApiParam(value = "The string value on which products will be filtered", required = false)
                    @RequestParam(required = false) final String mask, @ApiParam(value = "Defines the pageSize, currentPage and sorting order", required = true)
