...
class CatalogVersionController
{
    ...
    public CatalogVersionListData getWritableContentCatalogVersionsStartWith(
                    ...
                    @PathVariable("catalogId") final String catalogId, @ApiParam(value = "The site identifier", required = true)
                    @PathVariable("siteId") final String siteId, @ApiParam(value = "The version of the catalog", required = true)
                    @PathVariable("versionId") final String versionId, @ApiParam(value = "The mode to filter the result", required = true, example = MODE_CLONEABLE_TO)
