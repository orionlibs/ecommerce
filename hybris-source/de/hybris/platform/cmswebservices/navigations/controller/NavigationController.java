...
public class NavigationController
{
    ...
    @PathVariable("uid") final String uid, @ApiParam(value = "The navigation node data", required = true)
    ...
    @RequestBody final NavigationNodeData navigationNode, final HttpServletRequest request, final HttpServletResponse response)
