...
public class ItemSynchronizationController
{
    ...
    public SyncItemStatusWsDTO getPageSynchronizationStatus(@ApiParam(value = "The catalog id", required = true)
                    @PathVariable final String catalogId, @ApiParam(value = "The source catalog version from a synchronization perspective", required = true)
                    @PathVariable final String versionId, @ApiParam(value = "The target catalog version from a synchronization perspective", required = true)
