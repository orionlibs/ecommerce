...
public class MediaContainerController
{
    ...
    public MediaContainerWsDTO getMediaContainerByCode(
                    ...
                    @PathVariable final String code) throws CMSItemNotFoundException
    {
    ...
    public MediaContainerListWsDTO findMediaContainersByText(
                    ...
                    @RequestParam(required = false) final String mask, @ApiParam(value = "PageableWsDTO", required = true)
