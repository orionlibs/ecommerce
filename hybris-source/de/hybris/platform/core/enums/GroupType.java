...
{
    public static final String _TYPECODE = "GroupType";
    public static final String SIMPLE_CLASSNAME = "GroupType";
    private static final ConcurrentMap<String, GroupType> cache = new ConcurrentHashMap<>();
    ...
    public static GroupType valueOf(String code)
    {
