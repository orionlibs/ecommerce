...
@Deprecated
public class DefaultMediaReferenceCollectionEditorModel extends DefaultReferenceCollectionEditorModel
{
    ...
    public DefaultMediaReferenceCollectionEditorModel(ObjectType rootType)
    {
        super(rootType);
    }
    ...
    public String getMnemonic(Object object)
    {
        ...
        if(object instanceof TypedObject)
        {
            ...
            {
                CatalogVersion catalogVersion = CatalogManager.getInstance().getCatalogVersion((Item)getModelService().getSource(item));
    ...
    {
        this.referenceSelectorModel = (DefaultReferenceSelectorModel)new DefaultMediaReferenceSelectorModel(rootType);
