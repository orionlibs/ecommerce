...
{
    public static final String WIDGET_TYPE_PREFIX = "_widget_";
    ...
    {
        super("_widget_" + composedType.getCode());
    ...
    public String getName(String languageIsoCode)
    {
        ...
        try
        {
            ...
            name = "_widget_" + getComposedType().getName(ctx.getLocale());
        }
        finally
        {
    ...
    public String getDescription(String languageIsoCode)
    {
        ...
        try
        {
            ...
            description = "_widget_" + getComposedType().getDescription(ctx.getLocale());
        }
        finally
        {
            JaloSession.getCurrentSession().removeLocalSessionContext();
