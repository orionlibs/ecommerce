...
public class EditCommentFromCommentLayerAction extends EditCommentAction
{
    ...
    public String getImageURI(ListViewAction.Context context)
    {
        ...
        return this.commentLayerService.canUserEditComment(UISessionUtils.getCurrentSession().getUser(), (AbstractCommentModel)object) ? "/cockpit/css/images/icon_func_edit_available.png" :
                        "/cockpit/css/images/icon_func_edit_unavailable.png";
    }
