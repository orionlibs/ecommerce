...
public class DeleteCommentFromCommentLayerAction extends DeleteCommentAction
{
    ...
    public String getImageURI(ListViewAction.Context context)
    {
        ...
        return
                        this.commentLayerService.canUserDeleteComment(UISessionUtils.getCurrentSession().getUser(), (AbstractCommentModel)object) ? "/cockpit/css/images/icon_func_delete_available.png" :
                                        "/cockpit/css/images/icon_func_delete_unavailable.png";
    }
