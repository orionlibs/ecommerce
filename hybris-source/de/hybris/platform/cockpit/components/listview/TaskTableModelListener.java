...
{
    private static final Logger log = LoggerFactory.getLogger(TaskTableModelListener.class);
    protected final UIListView view;
    protected final AdvancedBrowserModel browser;


    public TaskTableModelListener(BrowserModel browser, UIListView view)
    {
        this.view = view;
    ...
    {
        this.browser.getArea().updateActiveItems();
