...
public class DefaultJasperReportsRefreshService implements JasperReportsRefreshService
{
    ...
    private int delayInMilis(RefreshTimeOption refreshOption)
    {
        ...
        throw new IllegalArgumentException("Not implemented RefreshOption");
    }


    public void setJasperReportsCacheService(JasperReportCacheService jasperReportsCacheService)
    {
        this.jasperReportsCacheService = jasperReportsCacheService;
    }
}
