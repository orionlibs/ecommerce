...
public class LineNumberColumn extends DefaultCustomColumnConfiguration
{
    ...
    public LineNumberColumn(String name)
    {
        this.name = name;
    }
    ...
    public CellRenderer getCellRenderer()
    {
        ...
        {
            setCellRenderer((CellRenderer)new TestCustomCellRenderer(this));
        }
