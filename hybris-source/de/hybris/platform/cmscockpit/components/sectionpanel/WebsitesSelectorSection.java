...
public class WebsitesSelectorSection extends DefaultSectionSelectorSection
{
    ...
    {
        informBrowserAreaAboutSiteChanged();
        closeEditorArea();
        refreshView();
    }
    ...
    protected void informBrowserAreaAboutSiteChanged()
    {
        ...
        if(browserArea instanceof SiteVersionAware)
        {
            ...
            naviNodeBrowserArea.setActiveSite(siteModel);
            naviNodeBrowserArea.setActiveCatalogVersion(null);
