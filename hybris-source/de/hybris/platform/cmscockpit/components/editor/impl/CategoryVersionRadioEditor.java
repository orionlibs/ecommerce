...
public class CategoryVersionRadioEditor extends AbstractReferenceUIEditor
{
    ...
    public CategoryVersionRadioEditor(ObjectType rootType)
    {
    ...
    public HtmlBasedComponent createViewComponent(Object initialValue, Map<String, ? extends Object> parameters, EditorListener listener)
    {
        ...
        this.checkBoxComponent = (CategoryVersionCheckboxComponent)new Object(this, listener, additionalListener, listener);
        ...
        {
            Collection<CatalogModel> available = new ArrayList<>();
            available.addAll((Collection<? extends CatalogModel>)parameters.get("availableItems"));
            this.model.setCollectionItems(new ArrayList(UISessionUtils.getCurrentSession().getTypeService().wrapItems(available)));
        }
        else
        {
            this.model.setCollectionItems(Collections.EMPTY_LIST);
