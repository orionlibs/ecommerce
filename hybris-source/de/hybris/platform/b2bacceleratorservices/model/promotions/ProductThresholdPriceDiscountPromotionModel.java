...
public class ProductThresholdPriceDiscountPromotionModel extends ProductPromotionModel
{
    ...
    public ProductThresholdPriceDiscountPromotionModel(String _code)
    {
        setCode(_code);
    }
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public ProductThresholdPriceDiscountPromotionModel(String _code, ItemModel _owner)
    {
        setCode(_code);
        setOwner(_owner);
    }
    ...
    {
        return (Collection<PromotionPriceRowModel>)getPersistenceContext().getPropertyValue("productPriceDiscount");
    }
    ...
    {
        return (Collection<PromotionPriceRowModel>)getPersistenceContext().getPropertyValue("productThresholdPrice");
    }
    ...
    public void setProductPriceDiscount(Collection<PromotionPriceRowModel> value)
    {
    ...
    public void setProductThresholdPrice(Collection<PromotionPriceRowModel> value)
    {
