...
public class DefaultExpressionVisitor implements ExpressionVisitor
{
    ...
    private de.hybris.platform.odata2services.filter.OrderByExpressionVisitor orderByExpressionVisitor;
    private de.hybris.platform.odata2services.filter.OrderExpressionVisitor orderExpressionVisitor;
    ...
    @Override
    public Object visitOrderByExpression(final OrderByExpression expression, final String expressionString, final List<Object> orders)
    {
        return getOrderByExpressionVisitor().visit(expression, expressionString, orders);
    }


    @Override
    public Object visitOrder(final OrderExpression expression, final Object filterResult, final SortOrder sortOrder)
    {
        return getOrderExpressionVisitor().visit(expression, filterResult, sortOrder);
    }
    ...
    {
        return orderByExpressionVisitor;
    }


    public void setOrderByExpressionVisitor(final OrderByExpressionVisitor orderByExpressionVisitor)
    {
        this.orderByExpressionVisitor = orderByExpressionVisitor;
    }


    public OrderExpressionVisitor getOrderExpressionVisitor()
    {
        return orderExpressionVisitor;
    }


    public void setOrderExpressionVisitor(final OrderExpressionVisitor orderExpressionVisitor)
    {
        this.orderExpressionVisitor = orderExpressionVisitor;
    }
}
