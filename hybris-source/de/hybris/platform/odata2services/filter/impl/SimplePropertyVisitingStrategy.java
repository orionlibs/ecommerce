...
public class SimplePropertyVisitingStrategy implements BinaryExpressionVisitingStrategy
{
    ...
    {
        throwExceptionIfIntegrationKey(String.valueOf(leftResult));
        return new SimplePropertyWhereClauseCondition(String.valueOf(leftResult), getOperatorConverter().convert(operator), String.valueOf(rightResult)).toWhereClauseConditions();
    }
