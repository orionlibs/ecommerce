...
public interface ODataServicesConfiguration
{
    ...
    /**
     * Get the list of the exportable integration object codes.
     *
     * @return the list of the exportable integration object codes
     */
    default List<String> getExportableIntegrationObjects()
    {
    ...
    /**
     * Set the exportable integration objects.
     *
     * @param exportableIOs the list of exportable integration object codes
     */
    default void setExportableIntegrationObjects(final List<String> exportableIOs)
    {
    }
}
