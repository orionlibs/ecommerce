...
{
    private static final String HOOK_TYPE = "Post-Persist-Hook";
    private static final String POST_PERSIST_ERROR = "post_persist_error";


    public PostPersistHookException(final String hookName, final Throwable cause, final String integrationKey)
    {
        super(hookName, HOOK_TYPE, POST_PERSIST_ERROR, cause, integrationKey);
    }
}
