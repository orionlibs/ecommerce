...
{
    private static final Logger LOG = Log.getLogger(CallbackWriter.class);
    private static final String LOGGER_MESSAGE_TEMPLATE = "Encountered error while trying to get navigation property name from {}";
    private static final String ODATA_ERROR_MESSAGE = "Could not $expand navigation property.";
    ...
    private List<Map<String, Object>> getFeedEntries(final WriteFeedCallbackContext context) throws ODataApplicationException
    {
        ...
        {
            LOG.error(LOGGER_MESSAGE_TEMPLATE, context.getNavigationProperty(), e);
            throw new ODataApplicationException(ODATA_ERROR_MESSAGE, Locale.ENGLISH, e);
        }
    }
