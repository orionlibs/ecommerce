...
{
    private static final AnnotationAttribute NULLABLE_ANNOTATION = new AnnotationAttribute().setName("Nullable").setText("false");
    ...
    private Property valueProperty(final String primitiveType)
    {
        return new SimpleProperty()
                        ...
                        .setAnnotationAttributes(Collections.singletonList(NULLABLE_ANNOTATION));
    }
}
