...
public class ProductExpressUpdateCleanerCronJobModel extends CronJobModel
{
    ...
    public ProductExpressUpdateCleanerCronJobModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public ProductExpressUpdateCleanerCronJobModel(JobModel _job)
    {
        setJob(_job);
    }
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public ProductExpressUpdateCleanerCronJobModel(JobModel _job, ItemModel _owner)
    {
        setJob(_job);
        setOwner(_owner);
    }
