package de.hybris.platform.adminapi.jalo;
...
@SLDSafe
public class AdminapiManager extends Extension
{
    ...
    public static final AdminapiManager getInstance()
    {
        ExtensionManager em = JaloSession.getCurrentSession().getExtensionManager();
        return (AdminapiManager)em.getExtension("adminapi");
    }
