...
public class PaymentController
{
    ...
    public static final int START_YEARS = 6;
    public static final int EXPIRY_YEARS = 11;
    ...
    public Map<String, String> getStartYears()
    {
        ...
        for(int i = calender.get(Calendar.YEAR); i > (calender.get(Calendar.YEAR) - START_YEARS); i--)
        {
    ...
    public Map<String, String> getExpiryYears()
    {
        ...
        final Calendar calender = new GregorianCalendar();
        for(int i = calender.get(Calendar.YEAR); i < (calender.get(Calendar.YEAR) + EXPIRY_YEARS); i++)
        {
