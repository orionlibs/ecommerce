...
public class ProductConfiguratorTextfieldTemplateController
{
    ...
    public CartModificationWsDTO addCartEntry(@ApiParam(value = "Base site identifier.")
                    @PathVariable final String baseSiteId, @ApiParam(value = "Request body parameter (DTO in xml or json format) which contains details like : "
    ...
    @PathVariable final int entryNumber) throws CommerceCartModificationException
    {
    ...
    public ConfigurationInfoListWsDTO getConfigurationForOrderEntry(
                    ...
                    @PathVariable("entryNumber") final int entryNumber) throws CommerceCartModificationException
    {
    ...
    public ConfigurationInfoListWsDTO getConfigurationForSavedCartEntry(
                    ...
                    @PathVariable("entryNumber") final int entryNumber) throws CommerceCartModificationException, CommerceSaveCartException
    {
    ...
    @PathVariable final int entryNumber, @ApiParam(value = "Request body parameter (DTO in xml or json format) which contains details like : "
                    + "product code (product.code), quantity of product (quantity), pickup store name (deliveryPointOfService.name)", required = true)
    @RequestBody final ConfigurationInfoListWsDTO configInfoList) throws CommerceCartModificationException
    {
        final CartData cart = getCartFacade().getSessionCart();
        final OrderEntryData entry = getTextFieldFacade().getAbstractOrderEntry(entryNumber, cart);
