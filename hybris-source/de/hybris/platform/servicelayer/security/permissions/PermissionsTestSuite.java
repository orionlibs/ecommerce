...
@RunWith(Suite.class)
@SuiteClasses({DefaultPermissionManagementServiceTest.class, PermissionCheckingServiceTest.class, DefaultPermissionCheckValueMappingStrategyTest.class, PermissionCRUDServiceTest.class})
