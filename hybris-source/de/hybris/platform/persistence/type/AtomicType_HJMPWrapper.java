...
public class AtomicType_HJMPWrapper extends AtomicTypeEJB
{
    ...
    public static final String TYPECODE_STR = "81".intern();
    ...
    static
    {
        ...
        log = Logger.getLogger(AtomicType_HJMPWrapper.class.getName());
    }
    ...
    AtomicTypeEntityState entityState = null;
    ...
    private final AtomicTypeEntityState getEntityState()
    {
    ...
    private final void setEntityState(AtomicTypeEntityState newEntityState)
    {
    ...
    private final void loadData()
    {
        ...
        AtomicTypeEntityState state = AtomicTypeEntityStateCacheUnit.getInstance(getEntityContext().getPersistencePool(), getEntityContext().getItemDeployment(), pk).getEntityState();
        if(LOG)
        {
    ...
    {
        if(getEntityContext().getPersistencePool().isSystemCriticalType(81))
        {
    ...
    public AtomicTypeRemote create(PK param0, AtomicTypeRemote param1, Class param2) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        throw new HJMPException("is never called!!");
    }


    public PK ejbCreate(PK param0, AtomicTypeRemote param1, Class param2) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        try
        {
            RevertibleUpdate theUpdate = OperationInfo.updateThread(getEJBOperationInfo());
    ...
    public AtomicTypeRemote create(PK param0, AtomicTypeRemote param1, String param2) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        throw new HJMPException("is never called!!");
    }


    public PK ejbCreate(PK param0, AtomicTypeRemote param1, String param2) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        try
        {
            RevertibleUpdate theUpdate = OperationInfo.updateThread(getEJBOperationInfo());
    ...
    public AtomicTypeRemote create(PK param0, Class param1) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        throw new HJMPException("is never called!!");
    }


    public PK ejbCreate(PK param0, Class param1) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        try
        {
            RevertibleUpdate theUpdate = OperationInfo.updateThread(getEJBOperationInfo());
    ...
    public AtomicTypeRemote create(PK param0, String param1, ComposedTypeRemote param2) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        throw new HJMPException("is never called!!");
    }
    ...
    public void ejbPostCreate(PK param0, AtomicTypeRemote param1, Class param2) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
    ...
    public void ejbPostCreate(PK param0, AtomicTypeRemote param1, String param2) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        super.ejbPostCreate(param0, param1, param2);
        if(needsStoring())
        {
    ...
    public void ejbPostCreate(PK param0, Class param1) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
    ...
    private static final PK handleResultRow(PersistencePool pool, ItemDeployment depl, ResultSet rs)
    {
        try
        {
            ...
            (new AtomicTypeEntityStateCacheUnit(pool, depl, pk)).hintEntityState(new AtomicTypeEntityState(pool, depl, rs));
            return pk;
        }
        catch(SQLException e)
        {
    ...
    {
        AtomicTypeEntityState entityState = getEntityState();
        PK result = getEntityState().getPkString();
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting PkString for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    {
        AtomicTypeEntityState oldEntityState = getEntityState();
        AtomicTypeEntityState newEntityState = null;
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting PkString for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public Date getCreationTimestampInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting CreationTimestampInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setCreationTimestampInternal(Date newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting CreationTimestampInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public Date getModifiedTimestampInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting ModifiedTimestampInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setModifiedTimestampInternal(Date newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting ModifiedTimestampInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public long getACLTimestampInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting ACLTimestampInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setACLTimestampInternal(long newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting ACLTimestampInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public PK getTypePkString()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting TypePkString for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setTypePkString(PK newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting TypePkString for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public PK getOwnerPkString()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting OwnerPkString for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setOwnerPkString(PK newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting OwnerPkString for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public long getPropertyTimestampInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting PropertyTimestampInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setPropertyTimestampInternal(long newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting PropertyTimestampInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public String getInternalCode()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting InternalCode for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setInternalCode(String newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting InternalCode for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public String getInternalCodeLowerCase()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting InternalCodeLowerCase for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setInternalCodeLowerCase(String newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting InternalCodeLowerCase for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public PK getSuperTypePK()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting SuperTypePK for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setSuperTypePK(PK newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting SuperTypePK for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public String getInheritancePathStringInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting InheritancePathStringInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setInheritancePathStringInternal(String newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting InheritancePathStringInternal for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    {
        AtomicTypeEntityState entityState = getEntityState();
        String result = getEntityState().getJavaClassName();
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting JavaClassName for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setJavaClassName(String newvalue)
    {
        ...
        if(CHECK_VALUE_DIFFERENCES)
        {
            String oldvalue = oldEntityState.getJavaClassName();
            if(oldvalue != newvalue && (oldvalue == null || !oldvalue.equals(newvalue)))
            {
                newEntityState = oldEntityState.setJavaClassName(newvalue);
                setEntityState(newEntityState);
            }
        }
        else
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting JavaClassName for " + this.entityContext.getPK() + " in AtomicType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }


    public AtomicTypeRemote findByPrimaryKey(PK pkValue) throws YObjectNotFoundException, YFinderException
    {
    ...
    public PK ejbFindByPrimaryKey(PK pkValue) throws YObjectNotFoundException
    {
        if(LOG)
        {
            log.debug("AtomicType ejbFindByPrimaryKey " + pkValue);
        }
        try
        {
            return AtomicTypeEntityStateCacheUnit.getInstance(getEntityContext().getPersistencePool(), getEntityContext().getItemDeployment(), pkValue).getEntityState().getPK();
        }
    ...
    public Collection ejbFindByType(PK param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("AtomicType ejbFindByType");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
    ...
    public Collection ejbFindChangedAfter(Date param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("AtomicType ejbFindChangedAfter");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
    ...
    public Collection findByJavaClass(String param0) throws YFinderException
    {
        return (Collection)EJBTools.convertEntityFinderResult(ejbFindByJavaClass(param0), getEntityContext().getPersistencePool().getTenant().getSystemEJB());
    }


    public Collection ejbFindByJavaClass(String param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("AtomicType ejbFindByJavaClass");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
            }
            Object resultObject = (new FindByJavaClass1FinderResult(getEntityContext().getPersistencePool(), getEntityContext().getItemDeployment(), param0)).getFinderResult();
            if(LOG)
            {
                log.debug("  result=" + resultObject);
            }
    ...
    public Collection ejbFindByCodeExact(String param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("AtomicType ejbFindByCodeExact");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
    ...
    public Collection ejbFindAll() throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("AtomicType ejbFindAll");
            }
    ...
    public Collection ejbFindByInheritancePath(String param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("AtomicType ejbFindByInheritancePath");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
    ...
    public Collection ejbFindBySuperType(PK param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("AtomicType ejbFindBySuperType");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
    ...
    public Collection ejbFindByPKList(Collection pks) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("AtomicType ejbFindByPKList");
            }
            if(LOG)
            {
                log.debug("  0->" + pks);
    ...
    {
        return "de.hybris.platform.persistence.type.AtomicType";
    }
