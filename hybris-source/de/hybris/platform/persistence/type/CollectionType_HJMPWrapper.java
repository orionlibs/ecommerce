...
public class CollectionType_HJMPWrapper extends CollectionTypeEJB
{
    ...
    static
    {
        ...
        log = Logger.getLogger(CollectionType_HJMPWrapper.class.getName());
    }
    ...
    CollectionTypeEntityState entityState = null;
    ...
    private final CollectionTypeEntityState getEntityState()
    {
    ...
    private final void setEntityState(CollectionTypeEntityState newEntityState)
    {
    ...
    private final void loadData()
    {
        ...
        CollectionTypeEntityState state = CollectionTypeEntityStateCacheUnit.getInstance(getEntityContext().getPersistencePool(), getEntityContext().getItemDeployment(), pk).getEntityState();
        if(LOG)
        {
    ...
    {
        if(getEntityContext().getPersistencePool().isSystemCriticalType(83))
        {
    ...
    public CollectionTypeRemote create(PK param0, String param1, TypeRemote param2, int param3) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        throw new HJMPException("is never called!!");
    }


    public PK ejbCreate(PK param0, String param1, TypeRemote param2, int param3) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        try
        {
            RevertibleUpdate theUpdate = OperationInfo.updateThread(getEJBOperationInfo());
    ...
    public CollectionTypeRemote create(PK param0, String param1, ComposedTypeRemote param2) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
        throw new HJMPException("is never called!!");
    }
    ...
    public void ejbPostCreate(PK param0, String param1, TypeRemote param2, int param3) throws EJBDuplicateCodeException, EJBInvalidParameterException
    {
    ...
    private static final PK handleResultRow(PersistencePool pool, ItemDeployment depl, ResultSet rs)
    {
        try
        {
            ...
            (new CollectionTypeEntityStateCacheUnit(pool, depl, pk)).hintEntityState(new CollectionTypeEntityState(pool, depl, rs));
            return pk;
        }
        catch(SQLException e)
        {
    ...
    {
        CollectionTypeEntityState entityState = getEntityState();
        PK result = getEntityState().getPkString();
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting PkString for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    {
        CollectionTypeEntityState oldEntityState = getEntityState();
        CollectionTypeEntityState newEntityState = null;
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting PkString for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public Date getCreationTimestampInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting CreationTimestampInternal for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setCreationTimestampInternal(Date newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting CreationTimestampInternal for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public Date getModifiedTimestampInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting ModifiedTimestampInternal for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setModifiedTimestampInternal(Date newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting ModifiedTimestampInternal for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public long getACLTimestampInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting ACLTimestampInternal for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setACLTimestampInternal(long newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting ACLTimestampInternal for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public PK getTypePkString()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting TypePkString for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setTypePkString(PK newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting TypePkString for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public PK getOwnerPkString()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting OwnerPkString for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setOwnerPkString(PK newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting OwnerPkString for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public long getPropertyTimestampInternal()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting PropertyTimestampInternal for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setPropertyTimestampInternal(long newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting PropertyTimestampInternal for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public String getInternalCode()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting InternalCode for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setInternalCode(String newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting InternalCode for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    public String getInternalCodeLowerCase()
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting InternalCodeLowerCase for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }
    ...
    public void setInternalCodeLowerCase(String newvalue)
    {
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting InternalCodeLowerCase for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }


    public PK getElementTypePK()
    {
        CollectionTypeEntityState entityState = getEntityState();
        PK result = getEntityState().getElementTypePK();
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting ElementTypePK for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }


    public void setElementTypePK(PK newvalue)
    {
        CollectionTypeEntityState oldEntityState = getEntityState();
        CollectionTypeEntityState newEntityState = null;
        if(CHECK_VALUE_DIFFERENCES)
        {
            PK oldvalue = oldEntityState.getElementTypePK();
            if(oldvalue != newvalue && (oldvalue == null || !oldvalue.equals(newvalue)))
            {
                newEntityState = oldEntityState.setElementTypePK(newvalue);
                setEntityState(newEntityState);
            }
        }
        else
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting ElementTypePK for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }
    ...
    {
        CollectionTypeEntityState entityState = getEntityState();
        int result = getEntityState().getTypeOfCollection();
        if(LOG_ATTRIBUTEACCESS)
        {
            log.debug("getting TypeOfCollection for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " sid=" + entityState.getID() + ": " + result);
        }
        return result;
    }


    public void setTypeOfCollection(int newvalue)
    {
        CollectionTypeEntityState oldEntityState = getEntityState();
        CollectionTypeEntityState newEntityState = null;
        if(CHECK_VALUE_DIFFERENCES)
        {
            int oldvalue = oldEntityState.getTypeOfCollection();
            if(oldvalue != newvalue)
            {
                newEntityState = oldEntityState.setTypeOfCollection(newvalue);
                setEntityState(newEntityState);
            }
        }
        else
        ...
        if(LOG_ATTRIBUTEACCESS)
        {
            ...
            log.debug("setting TypeOfCollection for " + this.entityContext.getPK() + " in CollectionType eid=" + getID() + " " + sidString + ": " + newvalue);
        }
    }


    public CollectionTypeRemote findByPrimaryKey(PK pkValue) throws YObjectNotFoundException, YFinderException
    {
    ...
    public PK ejbFindByPrimaryKey(PK pkValue) throws YObjectNotFoundException
    {
        if(LOG)
        {
            log.debug("CollectionType ejbFindByPrimaryKey " + pkValue);
        }
        try
        {
            return CollectionTypeEntityStateCacheUnit.getInstance(getEntityContext().getPersistencePool(), getEntityContext().getItemDeployment(), pkValue).getEntityState().getPK();
        }
    ...
    public Collection ejbFindByType(PK param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("CollectionType ejbFindByType");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
    ...
    public Collection ejbFindChangedAfter(Date param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("CollectionType ejbFindChangedAfter");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
    ...
    public Collection findByElementType(PK param0) throws YFinderException
    {
        return (Collection)EJBTools.convertEntityFinderResult(ejbFindByElementType(param0), getEntityContext().getPersistencePool().getTenant().getSystemEJB());
    }


    public Collection ejbFindByElementType(PK param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("CollectionType ejbFindByElementType");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
            }
            Object resultObject = (new FindByElementType1FinderResult(getEntityContext().getPersistencePool(), getEntityContext().getItemDeployment(), param0)).getFinderResult();
            if(LOG)
            {
                log.debug("  result=" + resultObject);
            }
    ...
    public Collection ejbFindByCodeExact(String param0) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("CollectionType ejbFindByCodeExact");
            }
            if(LOG)
            {
                log.debug("  0->" + param0);
    ...
    public Collection ejbFindAll() throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("CollectionType ejbFindAll");
            }
    ...
    public Collection ejbFindByPKList(Collection pks) throws YFinderException
    {
        try
        {
            if(LOG)
            {
                log.debug("CollectionType ejbFindByPKList");
            }
            if(LOG)
            {
                log.debug("  0->" + pks);
    ...
    {
        return "de.hybris.platform.persistence.type.CollectionType";
    }
