...
class JaloSetLinkOperationForSingleLanguage extends JaloLinkOperation
{
    ...
    public JaloSetLinkOperationForSingleLanguage(SessionContext ctx, Item item, boolean itemIsSource, String qualifier, Language language, List<Item> items, boolean sortSrc2Tgt, boolean sortTgt2Src, boolean markModified)
    {
        this.ctx = ctx;
        this.item = item;
