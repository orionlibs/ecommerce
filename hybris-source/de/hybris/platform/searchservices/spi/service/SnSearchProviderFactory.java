...
{
    /**
     * Returns the {@link SnSearchProvider} instance for the given configuration.
     *
     * @param configuration
     *           - the configuration
     *
     ...
     */
    <T extends AbstractSnSearchProviderConfiguration> SnSearchProvider<T> getSearchProviderForConfiguration(
                    AbstractSnSearchProviderConfiguration configuration);
     ...
     * @return {@link SnSearchProvider} instance
     */
    <T extends AbstractSnSearchProviderConfiguration> SnSearchProvider<T> getSearchProviderForContext(SnContext context);
