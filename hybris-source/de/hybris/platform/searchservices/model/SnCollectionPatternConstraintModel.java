...
public class SnCollectionPatternConstraintModel extends AttributeConstraintModel
{
    ...
    public SnCollectionPatternConstraintModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public SnCollectionPatternConstraintModel(Class _annotation, Set<RegexpFlag> _flags, String _id, String _regexp)
    {
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public SnCollectionPatternConstraintModel(Class _annotation, Set<RegexpFlag> _flags, String _id, ItemModel _owner, String _regexp)
    {
        setAnnotation(_annotation);
        setFlags(_flags);
        setId(_id);
