 ...
 */
public class WarehousingfacadesManager extends GeneratedWarehousingfacadesManager
{
    /**
     * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
     */
    private static final Logger LOG = LoggerFactory.getLogger(WarehousingfacadesManager.class.getName());
     ...
     */
    public static WarehousingfacadesManager getInstance()
    {
        return (WarehousingfacadesManager)Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                        .getExtension(WarehousingfacadesConstants.EXTENSIONNAME);
    }
     ...
     */
    public WarehousingfacadesManager() // NOPMD
    {
        if(LOG.isDebugEnabled())
        {
            LOG.debug("constructor of WarehousingfacadesManager called.");
        }
    }
