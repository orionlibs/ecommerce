...
public class AsnModelPopulator implements Populator<AsnData, AdvancedShippingNoticeModel>
{
    ...
    private WarehousingCommentService asnCommentService;
    ...
    protected WarehousingCommentService getAsnCommentService()
    {
    ...
    @Required
    public void setAsnCommentService(final WarehousingCommentService asnCommentService)
    {
