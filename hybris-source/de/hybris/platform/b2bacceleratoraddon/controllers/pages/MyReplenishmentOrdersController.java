...
public class MyReplenishmentOrdersController extends AbstractSearchPageController
{
    ...
    @PostMapping(value = "/my-replenishment/cancel/" + JOB_CODE_PATH_VARIABLE_PATTERN)
    @RequireHardLogIn
    ...
    @PostMapping(value = "/my-replenishment/detail/cancel/" + JOB_CODE_PATH_VARIABLE_PATTERN)
    @RequireHardLogIn
