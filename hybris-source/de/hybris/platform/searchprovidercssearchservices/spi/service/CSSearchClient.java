...
import com.hybris.charon.annotations.Decoder;
import com.hybris.charon.annotations.Encoder;
...
import de.hybris.platform.searchprovidercssearchservices.spi.util.JsonMapper.JsonDecoder;
import de.hybris.platform.searchprovidercssearchservices.spi.util.JsonMapper.JsonEncoder;
...
@OAuth
@Encoder(contentType = MediaType.APPLICATION_JSON, encoder = JsonEncoder.class)
@Decoder(contentType = MediaType.APPLICATION_JSON, decoder = JsonDecoder.class)
