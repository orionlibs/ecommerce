...
public class CategoryPageModel extends AbstractPageModel
{
    ...
    public CategoryPageModel(CatalogVersionModel _catalogVersion, PageTemplateModel _masterTemplate, String _uid)
    {
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public CategoryPageModel(CatalogVersionModel _catalogVersion, PageTemplateModel _masterTemplate, ItemModel _owner, String _uid)
    {
        setCatalogVersion(_catalogVersion);
        setMasterTemplate(_masterTemplate);
        setOwner(_owner);
