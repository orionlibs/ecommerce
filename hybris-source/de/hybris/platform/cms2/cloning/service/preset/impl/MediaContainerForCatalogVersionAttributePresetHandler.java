...
public class MediaContainerForCatalogVersionAttributePresetHandler implements AttributePresetHandler<CatalogVersionModel>
{
    private CatalogVersionModel targetCatalogVersion;


    public MediaContainerForCatalogVersionAttributePresetHandler(CatalogVersionModel targetCatalogVersion)
    {
    ...
    {
        return (component instanceof de.hybris.platform.core.model.media.MediaContainerModel && "catalogVersion".equals(qualifier));
    }
