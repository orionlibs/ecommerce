...
public class MediaContainerTypePredicate implements Predicate<VersionAttributeDescriptor>
{
    ...
    {
        return getTypeService().isAssignableFrom("MediaContainer", attributeDescriptor.getType().getCode());
    }
