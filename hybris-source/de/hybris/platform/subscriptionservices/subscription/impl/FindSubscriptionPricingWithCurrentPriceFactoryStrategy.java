 ...
 * {@link de.hybris.platform.subscriptionservices.subscription.impl.SubscriptionFindDiscountValuesHook} instead.
 */
...
public class FindSubscriptionPricingWithCurrentPriceFactoryStrategy extends FindPricingWithCurrentPriceFactoryStrategy
{
    ...
    private transient SubscriptionCommercePriceService commercePriceService;
    private transient SubscriptionProductService subscriptionProductService;
    ...
    public PriceValue findBasePrice(@Nonnull final AbstractOrderEntryModel entry) throws CalculationException
    {
        ...
        if(order == null || order.getBillingTime() == null)
        {
            return super.findBasePrice(entry);
        }
        else
