...
public class DefaultSubscriptionCommerceCartService extends DefaultCommerceCartService implements SubscriptionCommerceCartService
{
    ...
    @Override
    @Nullable
    public CartModel getChildCartForBillingTime(@Nonnull final CartModel masterCart, @Nonnull final BillingTimeModel billFreq)
    {
    ...
    @Override
    @Nonnull
    public CartModel getMasterCartForCartEntry(@Nonnull final CartEntryModel cartEntryModel)
    {
