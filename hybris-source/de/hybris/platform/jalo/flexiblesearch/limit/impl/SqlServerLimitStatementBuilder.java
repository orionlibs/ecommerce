...
public class SqlServerLimitStatementBuilder implements LimitStatementBuilder
{
    private final LimitStatementBuilder state;


    public SqlServerLimitStatementBuilder(TranslatedQuery.ExecutableQuery originalQuery, int originalStart, int originalCount)
    {
        if(originalCount == 0)
        {
