...
public abstract class GeneratedPaymentMode extends GenericItem
{
    ...
    static
    {
        ...
        tmp.put("paymentInfoType", Item.AttributeMode.INITIAL);
    ...
    public String getDescription(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedPaymentMode.getDescription requires a session language", 0);
        }
    ...
    public void setDescription(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedPaymentMode.setDescription requires a session language", 0);
        }
    ...
    public String getName(SessionContext ctx)
    {
        if(ctx == null || ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedPaymentMode.getName requires a session language", 0);
        }
    ...
    public void setName(SessionContext ctx, String value)
    {
        ...
        if(ctx.getLanguage() == null)
        {
            throw new JaloInvalidParameterException("GeneratedPaymentMode.setName requires a session language", 0);
        }
    ...
    {
        return (ComposedType)getProperty(ctx, "paymentInfoType");
    }


    public ComposedType getPaymentInfoType()
    {
        return getPaymentInfoType(getSession().getSessionContext());
    }


    public void setPaymentInfoType(SessionContext ctx, ComposedType value)
    {
        setProperty(ctx, "paymentInfoType", value);
    }


    public void setPaymentInfoType(ComposedType value)
    {
        setPaymentInfoType(getSession().getSessionContext(), value);
    }


    public Collection<DeliveryMode> getSupportedDeliveryModes()
    {
        return getSupportedDeliveryModes(getSession().getSessionContext());
    }


    public abstract Collection<DeliveryMode> getSupportedDeliveryModes(SessionContext paramSessionContext);
}
