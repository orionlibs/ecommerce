...
public abstract class GeneratedUserRight extends GenericItem
{
    ...
    public String getName(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedUserRight.getName requires a session language", 0);
        }
    ...
    public void setName(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedUserRight.setName requires a session language", 0);
        }
