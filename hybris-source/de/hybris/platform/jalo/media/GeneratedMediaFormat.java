...
public abstract class GeneratedMediaFormat extends GenericItem
{
    ...
    public String getName(SessionContext ctx)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedMediaFormat.getName requires a session language", 0);
        }
    ...
    public void setName(SessionContext ctx, String value)
    {
        ...
        {
            throw new JaloInvalidParameterException("GeneratedMediaFormat.setName requires a session language", 0);
        }
