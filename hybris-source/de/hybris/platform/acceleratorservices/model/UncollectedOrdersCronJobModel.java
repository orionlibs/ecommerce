...
public class UncollectedOrdersCronJobModel extends CronJobModel
{
    ...
    public UncollectedOrdersCronJobModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public UncollectedOrdersCronJobModel(JobModel _job, Collection<BaseSiteModel> _sites)
    {
        setJob(_job);
        setSites(_sites);
    }
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public UncollectedOrdersCronJobModel(JobModel _job, ItemModel _owner, Collection<BaseSiteModel> _sites)
    {
        setJob(_job);
        setOwner(_owner);
        setSites(_sites);
