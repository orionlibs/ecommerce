...
public class SwaggerConfig
{
    ...
    private static final String DESC = "These services provide the ability for agents to assist customers with their order, and look up the order by name, email, cart, or order number.";
    private static final String TITLE = "Assisted Service Module Webservices";
