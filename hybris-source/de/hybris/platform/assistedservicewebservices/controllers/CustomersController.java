...
public class CustomersController extends AbstractAssistedServiceWebServiceController
{
    ...
    @ApiOperation(nickname = "autoComplete", value = "Returns customers to auto complete based on customerQuery parameter")
