...
public class CustomerListsController extends AbstractAssistedServiceWebServiceController
{
    ...
    @ApiOperation(nickname = "getCustomerLists", value = "Returns customer lists", notes = "This endpoint returns list of all customer lists. This can only be done when logged in")
    ...
    @ApiOperation(nickname = "getCustomerListDetails", value = "Returns single customer list details", notes = "This endpoint returns details of customer list with valid Id")
