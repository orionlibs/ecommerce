 ...
 */
public class AssistedserviceyprofilefacadesManager extends GeneratedAssistedserviceyprofilefacadesManager
{
    /** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
    private static final Logger LOG = LoggerFactory.getLogger(AssistedserviceyprofilefacadesManager.class);
     ...
     */
    public static AssistedserviceyprofilefacadesManager getInstance()
    {
        return (AssistedserviceyprofilefacadesManager)Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                        .getExtension(AssistedserviceyprofilefacadesConstants.EXTENSIONNAME);
    }
     ...
     */
    public AssistedserviceyprofilefacadesManager() // NOPMD
    {
        LOG.debug("constructor of AssistedserviceyprofilefacadesManager called.");
    }
    ...
    public void init()
    {
        LOG.debug("init() of AssistedserviceyprofilefacadesManager called, current tenant: {}", getTenant().getTenantID());
    }
    ...
    public void destroy()
    {
        LOG.debug("destroy() of AssistedserviceyprofilefacadesManager called, current tenant: {}", getTenant().getTenantID());
    }
