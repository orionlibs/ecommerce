...
public class HybrisDecimalMaxConstraintModel extends AttributeConstraintModel
{
    ...
    public HybrisDecimalMaxConstraintModel(Class _annotation, String _id, BigDecimal _value)
    {
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public HybrisDecimalMaxConstraintModel(Class _annotation, String _id, ItemModel _owner, BigDecimal _value)
    {
        setAnnotation(_annotation);
        setId(_id);
        setOwner(_owner);
