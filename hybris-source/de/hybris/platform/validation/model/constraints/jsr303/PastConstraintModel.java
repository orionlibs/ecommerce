...
public class PastConstraintModel extends AttributeConstraintModel
{
    ...
    public PastConstraintModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public PastConstraintModel(Class _annotation, String _id)
    {
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public PastConstraintModel(Class _annotation, String _id, ItemModel _owner)
    {
        setAnnotation(_annotation);
        setId(_id);
        setOwner(_owner);
