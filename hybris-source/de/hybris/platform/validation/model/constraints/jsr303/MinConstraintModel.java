...
public class MinConstraintModel extends AttributeConstraintModel
{
    ...
    public MinConstraintModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public MinConstraintModel(Class _annotation, String _id, Long _value)
    {
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public MinConstraintModel(Class _annotation, String _id, ItemModel _owner, Long _value)
    {
        setAnnotation(_annotation);
        setId(_id);
        setOwner(_owner);
