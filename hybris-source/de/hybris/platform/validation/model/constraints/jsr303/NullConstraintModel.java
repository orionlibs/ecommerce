...
public class NullConstraintModel extends AttributeConstraintModel
{
    ...
    public NullConstraintModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public NullConstraintModel(Class _annotation, String _id)
    {
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public NullConstraintModel(Class _annotation, String _id, ItemModel _owner)
    {
        setAnnotation(_annotation);
        setId(_id);
        setOwner(_owner);
