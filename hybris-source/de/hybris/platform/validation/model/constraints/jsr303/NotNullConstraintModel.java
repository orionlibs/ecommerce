...
public class NotNullConstraintModel extends AttributeConstraintModel
{
    ...
    public NotNullConstraintModel(ItemModelContext ctx)
    {
        super(ctx);
    }
    ...
    public NotNullConstraintModel(Class _annotation, String _id)
    {
    ...
    @Deprecated(since = "4.1.1", forRemoval = true)
    public NotNullConstraintModel(Class _annotation, String _id, ItemModel _owner)
    {
        setAnnotation(_annotation);
        setId(_id);
        setOwner(_owner);
