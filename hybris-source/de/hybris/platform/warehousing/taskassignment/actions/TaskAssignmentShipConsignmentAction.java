...
public class TaskAssignmentShipConsignmentAction extends AbstractTaskAssignmentActions
{
    ...
    public WorkflowDecisionModel perform(WorkflowActionModel workflowAction)
    {
        ...
        if(getAttachedConsignment(workflowAction).isPresent())
        {
            ...
            getWorkflowActionAndAssignPrincipal("NPR_Shipping", workflowAction, attachedConsignment, "shipped");
            getConsignmentBusinessProcessService()
                            .triggerChoiceEvent((ItemModel)attachedConsignment, "ConsignmentActionEvent", "confirmShipConsignment");
