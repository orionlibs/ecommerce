...
public class OrderEntryUnallocatedQuantityHandler implements DynamicAttributeHandler<Long, OrderEntryModel>
{
    ...
    {
        return getOrderEntryQuantityService().getQuantityUnallocated(orderEntry);
    }


    public void set(OrderEntryModel orderEntry, Long unallocatedQuantity)
    {
