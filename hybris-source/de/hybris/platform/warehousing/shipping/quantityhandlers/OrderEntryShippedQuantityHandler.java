...
public class OrderEntryShippedQuantityHandler implements DynamicAttributeHandler<Long, OrderEntryModel>
{
    ...
    {
        return getOrderEntryQuantityService().getQuantityShipped(orderEntry);
    }
