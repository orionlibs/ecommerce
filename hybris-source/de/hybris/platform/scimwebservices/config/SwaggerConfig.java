...
import static de.hybris.platform.scimwebservices.constants.ScimwebservicesConstants.AUTHORIZATION_NAME;
...
public class SwaggerConfig
{
    ...
    {
        final AuthorizationScope[] authorizationScopes = {};
        return Arrays.asList(new SecurityReference(AUTHORIZATION_NAME, authorizationScopes),
