...
public class PaymentCaptureManualReleaseButtonCellRenderer extends ReleaseButtonCellRenderer implements WidgetComponentRenderer<Listcell, ListColumn, ConsignmentModel>
{
    ...
    protected void executeManualRelease(ConsignmentModel consignmentModel)
    {
        if(canPerformOperation(consignmentModel, ConsignmentStatus.PAYMENT_NOT_CAPTURED))
        {
            triggerBusinessProcessEvent(consignmentModel, "ConsignmentActionEvent", "handleManualCapture");
        }
    }
