...
public class ArchiveYFormDefinitionAction extends AbstractComponentWidgetAdapterAware implements CockpitAction<Object, String>
{
    ...
    public boolean canPerform(final ActionContext<Object> ctx)
    {
        ...
        final PermissionFacade createdPermissionFacade = getPermissionFacade();
        if(createdPermissionFacade != null && ctx.getData() instanceof YFormDefinitionModel)
        {
            allowed = createdPermissionFacade.canChangeInstance(ctx.getData());
        }
        return allowed;
    }
