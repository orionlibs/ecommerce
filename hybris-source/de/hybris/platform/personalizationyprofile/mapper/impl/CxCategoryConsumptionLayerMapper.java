...
public class CxCategoryConsumptionLayerMapper extends AbstractAffinityMapper<Affinity>
{
    private static final String REQUIRED_FIELD = "insights.affinities.categories";
    private static final String ENABLED_PROPERTY = "personalizationyprofile.mapper.catalog.enabled";
