...
{
    private static final Logger LOG = Log.getLogger(HttpServletRequestToODataRequestConverter.class);
    ...
    private List<Locale> createLocales(final String languages)
    {
        ...
        {
            LOG.trace("An exception occurred while creating locales", e);
    ...
    protected Map<String, List<String>> extractRequestHeaders(final HttpServletRequest request)
    {
        return new HashMap<>(RestUtil.extractHeaders(request));
    }
}
