 ...
 */
public class DefaultInboundServicesConfiguration extends BaseIntegrationServicesConfiguration
                implements InboundServicesConfiguration
{
    ...
    private boolean legacySecurity = true;
    ...
    public void setLegacySecurity(final boolean legacySecurity)
    {
        this.legacySecurity = legacySecurity;
    }
}
