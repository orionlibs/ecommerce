...
@UnitTest
@SpecMetadata(filename = "BlacklistImageMagickSecurityServiceSpec.groovy", line = 10)
public class BlacklistImageMagickSecurityServiceSpec extends HybrisSpockSpecification
{
    ...
    @Test
    @FeatureMetadata(line = 46, name = "test invalid command", ordinal = 1, blocks = {@BlockMetadata(kind = BlockKind.WHEN, texts = {}), @BlockMetadata(kind = BlockKind.THEN, texts = {}), @BlockMetadata(kind = BlockKind.WHERE, texts = {})}, parameterNames = {"command"})
    public void $spock_feature_2_1(Object command)
    {
        ...
        try
        {
            SpockRuntime.verifyCondition($spock_errorCollector, $spock_valueRecorder.reset(), "!result.isSecure()", Integer.valueOf(52).intValue(), Integer.valueOf(9).intValue(), null, $spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(4).intValue()),
                            Boolean.valueOf(!DefaultTypeTransformation.booleanUnbox($spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(3).intValue()),
                                            ScriptBytecodeAdapter.invokeMethod0(BlacklistImageMagickSecurityServiceSpec.class, $spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(0).intValue()), result),
        ...
        {
            SpockRuntime.conditionFailedWithException($spock_errorCollector, $spock_valueRecorder, "!result.isSecure()", Integer.valueOf(52).intValue(), Integer.valueOf(9).intValue(), null, throwable);
            null;
        }
        finally
        {
    ...
    @Test
    @FeatureMetadata(line = 62, name = "test valid command list", ordinal = 2, blocks = {@BlockMetadata(kind = BlockKind.WHEN, texts = {}), @BlockMetadata(kind = BlockKind.THEN, texts = {}), @BlockMetadata(kind = BlockKind.WHERE, texts = {})}, parameterNames = {"command"})
    public void $spock_feature_2_2(Object command)
    {
        ...
        try
        {
            SpockRuntime.verifyMethodCondition($spock_errorCollector, $spock_valueRecorder.reset(), "result.isSecure()", Integer.valueOf(68).intValue(), Integer.valueOf(9).intValue(), null, $spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(0).intValue()), result),
                            ShortTypeHandling.castToString($spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(1).intValue()), "isSecure")), new Object[0],
                            DefaultTypeTransformation.booleanUnbox($spock_valueRecorder.realizeNas(Integer.valueOf(4).intValue(), Boolean.FALSE)), DefaultTypeTransformation.booleanUnbox(Boolean.FALSE), Integer.valueOf(3).intValue());
            null;
        }
        ...
        {
            SpockRuntime.conditionFailedWithException($spock_errorCollector, $spock_valueRecorder, "result.isSecure()", Integer.valueOf(68).intValue(), Integer.valueOf(9).intValue(), null, throwable);
            null;
        }
        finally
        {
    ...
    @Test
    @FeatureMetadata(line = 81, name = "test invalid command list", ordinal = 3, blocks = {@BlockMetadata(kind = BlockKind.WHEN, texts = {}), @BlockMetadata(kind = BlockKind.THEN, texts = {}), @BlockMetadata(kind = BlockKind.WHERE, texts = {})}, parameterNames = {"command"})
    public void $spock_feature_2_3(Object command)
    {
        ...
        arrayOfCallSite[13].callCurrent((GroovyObject)this, command);
        try
        {
            SpockRuntime.verifyCondition($spock_errorCollector, $spock_valueRecorder.reset(), "!result.isSecure()", Integer.valueOf(88).intValue(), Integer.valueOf(9).intValue(), null, $spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(4).intValue()),
                            Boolean.valueOf(!DefaultTypeTransformation.booleanUnbox($spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(3).intValue()),
                                            ScriptBytecodeAdapter.invokeMethod0(BlacklistImageMagickSecurityServiceSpec.class, $spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(0).intValue()), result),
                                                            ShortTypeHandling.castToString($spock_valueRecorder.record($spock_valueRecorder.startRecordingValue(Integer.valueOf(1).intValue()), "isSecure"))))))));
            null;
        ...
        {
            SpockRuntime.conditionFailedWithException($spock_errorCollector, $spock_valueRecorder, "!result.isSecure()", Integer.valueOf(88).intValue(), Integer.valueOf(9).intValue(), null, throwable);
            null;
        }
        finally
        {
