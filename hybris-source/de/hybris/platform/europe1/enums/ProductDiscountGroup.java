...
{
    public static final String _TYPECODE = "ProductDiscountGroup";
    public static final String SIMPLE_CLASSNAME = "ProductDiscountGroup";
    private static final ConcurrentMap<String, ProductDiscountGroup> cache = new ConcurrentHashMap<>();
    private final String code;
    private final String codeLowerCase;
    private static final long serialVersionUID = 0L;


    private ProductDiscountGroup(String code)
    {
    ...
    public static ProductDiscountGroup valueOf(String code)
    {
