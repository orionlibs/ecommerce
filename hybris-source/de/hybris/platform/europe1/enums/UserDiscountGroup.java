...
{
    public static final String _TYPECODE = "UserDiscountGroup";
    public static final String SIMPLE_CLASSNAME = "UserDiscountGroup";
    private static final ConcurrentMap<String, UserDiscountGroup> cache = new ConcurrentHashMap<>();
    private final String code;
    private final String codeLowerCase;
    private static final long serialVersionUID = 0L;


    private UserDiscountGroup(String code)
    {
    ...
    public static UserDiscountGroup valueOf(String code)
    {
