...
public abstract class GeneratedTaxRow extends PDTRow
{
    public static final String CATALOGVERSION = "catalogVersion";
    public static final String CURRENCY = "currency";
    public static final String TAX = "tax";
    public static final String VALUE = "value";
    protected static final BidirectionalOneToManyHandler<GeneratedTaxRow> PRODUCTHANDLER = new BidirectionalOneToManyHandler(GeneratedCoreConstants.TC.PRODUCT, false, "product", null, false, true, 0);
    ...
    public Tax getTax(SessionContext ctx)
    {
        return (Tax)getProperty(ctx, "tax");
    }
    ...
    protected void setTax(SessionContext ctx, Tax value)
    {
        ...
        {
            throw new JaloInvalidParameterException("attribute 'tax' is not changeable", 0);
        }
        setProperty(ctx, "tax", value);
    }


    protected void setTax(Tax value)
    {
